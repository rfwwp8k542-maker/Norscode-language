...
# Inkluderer runtime (python_version, python_major_minor, python_implementation, python_cache_tag, python_executable, byteorder, is_ci, is_github_actions, github_actions_run_id, github_actions_run_number, github_actions_workflow, github_actions_job, os, arch, platform, hostname, pid, cwd, timezone) for miljøsporing
