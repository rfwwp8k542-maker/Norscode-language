...
- Utvide selv-hosting til full parser (påbegynt: uttrykksparser + mini-skriptparser med assignments/deklarasjoner (`x=...;`, `la x=...;`) og norske bool-operator-ord (`og/eller/ikke`) i `selfhost/compiler.no`)
