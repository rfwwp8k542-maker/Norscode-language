...
- Utvide selv-hosting til full parser (påbegynt: uttrykksparser med precedens/paranteser + sammenligning/logisk + unære operatorer + bool-literaler + symbol-miljø + `tokeniser_uttrykk` i `selfhost/compiler.no`)
