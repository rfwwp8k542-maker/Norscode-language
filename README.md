...
# Inkluderer runtime (python_version, python_major_minor, python_implementation, python_executable, os, arch, platform, hostname, pid, cwd, timezone) for miljøsporing
