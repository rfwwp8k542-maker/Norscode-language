...
| Område | Status | Notat |
|---|---|---|
| Uttrykksparser (prioritet/assosiativitet) | Delvis | Fungerer i stor bredde med aliaser; core-sett med 45 cases (inkl. feilbaner) er lagt i `tests/selfhost_parser_core_cases.json` |
...
- Definere et fast `core parser parity`-testsett (20-30 representative programmer). Utvidet batch (45, inkl. `expected_error`) ligger i `tests/selfhost_parser_core_cases.json`.
