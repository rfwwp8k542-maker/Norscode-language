...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        static nl_map_text *nl_web_dispatch_params(nl_map_text *routes, const char *method, const char *path) {
            ...
            nl_map_text* std__json__parse(char * innhold) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.parse";
            ...
            char * std__json__stringify(nl_map_text* data) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.stringify";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            char * std__json__hent_tekst(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.hent_tekst";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            int std__json__hent_tall(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.hent_tall";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            int std__json__hent_bool(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.hent_bool";
                char * verdi = nl_map_text_get(data, nøkkel);
                if (nl_streq(verdi, "true")) {
                    nl_call_stack_len = nl_call_stack_mark;
                    return 1;
                }
                if (nl_streq(verdi, "false")) {
                    nl_call_stack_len = nl_call_stack_mark;
                    return 0;
                }
                nl_call_stack_len = nl_call_stack_mark;
            ...
            nl_list_text* std__json__array_til_tekst_liste(nl_map_text* data) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.array_til_tekst_liste";
                nl_list_text* resultat = nl_list_text_new();
                int i = 0;
                int n = nl_map_text_len(data);
                while ((i < n) && (nl_map_text_find(data, nl_int_to_text(i)) >= 0)) {
                    char * indeks = nl_int_to_text(i);
                    nl_list_text_push(resultat, nl_map_text_get(data, indeks));
                    i = (i + 1);
                }
                nl_call_stack_len = nl_call_stack_mark;
                return resultat;
            ...
            nl_list_int* std__json__array_til_tall_liste(nl_map_text* data) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.array_til_tall_liste";
                nl_list_int* resultat = nl_list_int_new();
                int i = 0;
                int n = nl_map_text_len(data);
                while ((i < n) && (nl_map_text_find(data, nl_int_to_text(i)) >= 0)) {
                    char * indeks = nl_int_to_text(i);
                    nl_list_int_push(resultat, std__json__hent_tall(data, indeks));
                    i = (i + 1);
                }
                nl_call_stack_len = nl_call_stack_mark;
                return resultat;
            ...
            nl_list_text* std__json__hent_array_tekst(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.hent_array_tekst";
                nl_map_text* rå = std__json__parse(nl_map_text_get(data, nøkkel));
                nl_call_stack_len = nl_call_stack_mark;
                return std__json__array_til_tekst_liste(rå);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_list_text_new();
            }
            
            nl_list_int* std__json__hent_array_tall(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.json.hent_array_tall";
                nl_map_text* rå = std__json__parse(nl_map_text_get(data, nøkkel));
                nl_call_stack_len = nl_call_stack_mark;
                return std__json__array_til_tall_liste(rå);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_list_int_new();
            }
            ...
            int start() {
                ...
                nl_map_text_set(data, "ok", "sann");
                nl_map_text_set(data, "text", "hei\nmed\nrad");
                nl_print_text(std__json__stringify(data));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
