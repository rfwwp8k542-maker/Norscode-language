...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        int start() {
            nl_list_text* exprs = nl_list_text_new();
            nl_list_text_push(exprs, "2+3*4");
            nl_list_text_push(exprs, "(2+3)*4");
            nl_list_text_push(exprs, "{2+3}*4");
            nl_list_text_push(exprs, "[2+3]*4");
            nl_list_text_push(exprs, "5>3&&2<4");
            nl_list_text_push(exprs, "7!=7||2==2");
            nl_list_text_push(exprs, "7<>8");
            nl_list_text_push(exprs, "1 xor 0");
            nl_list_text_push(exprs, "1 xnor 1");
            nl_list_text_push(exprs, "1 xeller_ikke 1");
            nl_list_text_push(exprs, "1 nand 1");
            nl_list_text_push(exprs, "1 and_not 1");
            nl_list_text_push(exprs, "1 og_ikke 1");
            nl_list_text_push(exprs, "0 nor 0");
            nl_list_text_push(exprs, "0 or_not 0");
            nl_list_text_push(exprs, "0 eller_ikke 0");
            nl_list_text_push(exprs, "1 implies 0");
            nl_list_text_push(exprs, "1 implies_that 0");
            nl_list_text_push(exprs, "1 this_implies 0");
            nl_list_text_push(exprs, "1 dette_impliserer 0");
            nl_list_text_push(exprs, "1 impliserer_at 0");
            nl_list_text_push(exprs, "1 impliserer 0");
            nl_list_text_push(exprs, "1 medforer 0");
            nl_list_text_push(exprs, "1 impl 0");
            nl_list_text_push(exprs, "1 impliser 0");
            nl_list_text_push(exprs, "1 follows 0");
            nl_list_text_push(exprs, "1 folger_av 0");
            nl_list_text_push(exprs, "1 it_follows_that 0");
            nl_list_text_push(exprs, "1 det_folger_at 0");
            nl_list_text_push(exprs, "1 therefore 0");
            nl_list_text_push(exprs, "1 derfor 0");
            nl_list_text_push(exprs, "1 hence 0");
            nl_list_text_push(exprs, "1 altsa 0");
            nl_list_text_push(exprs, "1 thus 0");
            nl_list_text_push(exprs, "1 dermed 0");
            nl_list_text_push(exprs, "1 consequently 0");
            nl_list_text_push(exprs, "1 folgelig 0");
            nl_list_text_push(exprs, "1 thereby 0");
            nl_list_text_push(exprs, "1 derved 0");
            nl_list_text_push(exprs, "1 thereupon 0");
            nl_list_text_push(exprs, "1 derpa 0");
            nl_list_text_push(exprs, "1 ergo 0");
            nl_list_text_push(exprs, "1 saledes 0");
            nl_list_text_push(exprs, "1 infer 0");
            nl_list_text_push(exprs, "1 derav 0");
            nl_list_text_push(exprs, "1 as_consequence 0");
            nl_list_text_push(exprs, "1 som_konsekvens 0");
            nl_list_text_push(exprs, "1 as_a_result 0");
            nl_list_text_push(exprs, "1 som_resultat 0");
            nl_list_text_push(exprs, "1 only_if 0");
            nl_list_text_push(exprs, "1 kun_hvis 0");
            nl_list_text_push(exprs, "1 requires 0");
            nl_list_text_push(exprs, "1 krever 0");
            nl_list_text_push(exprs, "1 -> 0");
            nl_list_text_push(exprs, "1 => 0");
            nl_list_text_push(exprs, "1 <- 0");
            nl_list_text_push(exprs, "1 implied_by 0");
            nl_list_text_push(exprs, "1 folger_fra 0");
            nl_list_text_push(exprs, "1 given 0");
            nl_list_text_push(exprs, "1 gitt 0");
            nl_list_text_push(exprs, "1 provided 0");
            nl_list_text_push(exprs, "1 forutsatt 0");
            nl_list_text_push(exprs, "1 assuming 0");
            nl_list_text_push(exprs, "1 antar 0");
            nl_list_text_push(exprs, "1 assuming_that 0");
            nl_list_text_push(exprs, "1 antar_at 0");
            nl_list_text_push(exprs, "1 when_assuming 0");
            nl_list_text_push(exprs, "1 nar_antatt 0");
            nl_list_text_push(exprs, "1 presuming 0");
            nl_list_text_push(exprs, "1 forutsattvis 0");
            nl_list_text_push(exprs, "1 since 0");
            nl_list_text_push(exprs, "1 siden 0");
            nl_list_text_push(exprs, "1 because 0");
            nl_list_text_push(exprs, "1 fordi 0");
            nl_list_text_push(exprs, "1 given_that 0");
            nl_list_text_push(exprs, "1 gitt_at 0");
            nl_list_text_push(exprs, "1 provided_that 0");
            nl_list_text_push(exprs, "1 forutsatt_at 0");
            nl_list_text_push(exprs, "1 follows_if 0");
            nl_list_text_push(exprs, "1 folger_hvis 0");
            nl_list_text_push(exprs, "1 if_given 0");
            nl_list_text_push(exprs, "1 hvis_gitt 0");
            nl_list_text_push(exprs, "1 as 0");
            nl_list_text_push(exprs, "1 ettersom 0");
            nl_list_text_push(exprs, "1 inasmuch_as 0");
            nl_list_text_push(exprs, "1 i_og_med_at 0");
            nl_list_text_push(exprs, "1 on_condition_that 0");
            nl_list_text_push(exprs, "1 pa_vilkar_av_at 0");
            nl_list_text_push(exprs, "1 granted 0");
            nl_list_text_push(exprs, "1 gitt_dette 0");
            nl_list_text_push(exprs, "1 with_premise 0");
            nl_list_text_push(exprs, "1 med_premiss 0");
            nl_list_text_push(exprs, "1 given_premise 0");
            nl_list_text_push(exprs, "1 gitt_premiss 0");
            nl_list_text_push(exprs, "1 premise_given 0");
            nl_list_text_push(exprs, "1 premiss_gitt 0");
            nl_list_text_push(exprs, "1 premise_assumed 0");
            nl_list_text_push(exprs, "1 premiss_antatt 0");
            nl_list_text_push(exprs, "1 premise_condition 0");
            nl_list_text_push(exprs, "1 premiss_vilkar 0");
            nl_list_text_push(exprs, "1 iff 1");
            nl_list_text_push(exprs, "1 equiv 1");
            nl_list_text_push(exprs, "1 ekvivalent 1");
            nl_list_text_push(exprs, "1 if_and_only_if 1");
            nl_list_text_push(exprs, "1 hvis_og_bare_hvis 1");
            nl_list_text_push(exprs, "1 <-> 1");
            nl_list_text_push(exprs, "1 <=> 1");
            nl_list_text_push(exprs, "3 <= 4");
            nl_list_text_push(exprs, "4 >= 3");
            nl_list_text_push(exprs, "!0||0");
            nl_list_text_push(exprs, "-3+5");
            nl_list_text_push(exprs, "10 minus med 3");
            nl_list_text_push(exprs, "10 minus_med 3");
            nl_list_text_push(exprs, "10 minusmed 3");
            nl_list_text_push(exprs, "10 minuseres med 3");
            nl_list_text_push(exprs, "10 minuseres_med 3");
            nl_list_text_push(exprs, "10 minuseresmed 3");
            nl_list_text_push(exprs, "10 trekk med 3");
            nl_list_text_push(exprs, "10 trekk_med 3");
            nl_list_text_push(exprs, "10 trekkmed 3");
            nl_list_text_push(exprs, "10 trekke med 3");
            nl_list_text_push(exprs, "10 trekke_med 3");
            nl_list_text_push(exprs, "10 trekkemed 3");
            nl_list_text_push(exprs, "10 trekkes med 3");
            nl_list_text_push(exprs, "10 trekkes_med 3");
            nl_list_text_push(exprs, "10 trekkesmed 3");
            nl_list_text_push(exprs, "10 subtraher med 3");
            nl_list_text_push(exprs, "10 subtraher_med 3");
            nl_list_text_push(exprs, "10 subtrahermed 3");
            nl_list_text_push(exprs, "10 subtraherer med 3");
            nl_list_text_push(exprs, "10 subtraherer_med 3");
            nl_list_text_push(exprs, "10 subtraherermed 3");
            nl_list_text_push(exprs, "10 subtraheres med 3");
            nl_list_text_push(exprs, "10 subtraheres_med 3");
            nl_list_text_push(exprs, "10 subtraheresmed 3");
            nl_list_text_push(exprs, "10 subtrahert med 3");
            nl_list_text_push(exprs, "10 subtrahert_med 3");
            nl_list_text_push(exprs, "10 subtrahertmed 3");
            nl_list_text_push(exprs, "10 trekk 3");
            nl_list_text_push(exprs, "10 trekke 3");
            nl_list_text_push(exprs, "10 subtraher 3");
            nl_list_text_push(exprs, "10 subtrahert 3");
            nl_list_text_push(exprs, "+3+5");
            nl_list_text_push(exprs, "2 pluss 3 ganger 4");
            nl_list_text_push(exprs, "2 legg til 3");
            nl_list_text_push(exprs, "2 legg_til 3");
            nl_list_text_push(exprs, "2 legge til 3");
            nl_list_text_push(exprs, "2 legge_til 3");
            nl_list_text_push(exprs, "2 legges til 3");
            nl_list_text_push(exprs, "2 legges_til 3");
            nl_list_text_push(exprs, "2 leggtil 3");
            nl_list_text_push(exprs, "2 leggetil 3");
            nl_list_text_push(exprs, "2 leggestil 3");
            nl_list_text_push(exprs, "2 legg sammen 3");
            nl_list_text_push(exprs, "2 legg_sammen 3");
            nl_list_text_push(exprs, "2 legge sammen 3");
            nl_list_text_push(exprs, "2 legge_sammen 3");
            nl_list_text_push(exprs, "2 legges sammen 3");
            nl_list_text_push(exprs, "2 legges_sammen 3");
            nl_list_text_push(exprs, "2 leggsammen 3");
            nl_list_text_push(exprs, "2 leggesammen 3");
            nl_list_text_push(exprs, "2 leggessammen 3");
            nl_list_text_push(exprs, "2 legg 3");
            nl_list_text_push(exprs, "2 legge 3");
            nl_list_text_push(exprs, "2 legges 3");
            nl_list_text_push(exprs, "2 pluss med 3");
            nl_list_text_push(exprs, "2 pluss_med 3");
            nl_list_text_push(exprs, "2 plussmed 3");
            nl_list_text_push(exprs, "2 plus 3");
            nl_list_text_push(exprs, "2 plus med 3");
            nl_list_text_push(exprs, "2 plus_med 3");
            nl_list_text_push(exprs, "2 plusmed 3");
            nl_list_text_push(exprs, "2 plusser med 3");
            nl_list_text_push(exprs, "2 plusser_med 3");
            nl_list_text_push(exprs, "2 plussermed 3");
            nl_list_text_push(exprs, "2 plusses med 3");
            nl_list_text_push(exprs, "2 plusses_med 3");
            nl_list_text_push(exprs, "2 plussesmed 3");
            nl_list_text_push(exprs, "2 pluses med 3");
            nl_list_text_push(exprs, "2 pluses_med 3");
            nl_list_text_push(exprs, "2 plusesmed 3");
            nl_list_text_push(exprs, "2 plusse med 3");
            nl_list_text_push(exprs, "2 plusse_med 3");
            nl_list_text_push(exprs, "2 plussemed 3");
            nl_list_text_push(exprs, "2 plusser 3");
            nl_list_text_push(exprs, "2 adder med 3");
            nl_list_text_push(exprs, "2 adder_med 3");
            nl_list_text_push(exprs, "2 addermed 3");
            nl_list_text_push(exprs, "2 addere med 3");
            nl_list_text_push(exprs, "2 addere_med 3");
            nl_list_text_push(exprs, "2 adderemed 3");
            nl_list_text_push(exprs, "2 adderer med 3");
            nl_list_text_push(exprs, "2 adderer_med 3");
            nl_list_text_push(exprs, "2 adderermed 3");
            nl_list_text_push(exprs, "2 adderes med 3");
            nl_list_text_push(exprs, "2 adderes_med 3");
            nl_list_text_push(exprs, "2 adderesmed 3");
            nl_list_text_push(exprs, "2 adder 3");
            nl_list_text_push(exprs, "2 summer med 3");
            nl_list_text_push(exprs, "2 summer_med 3");
            nl_list_text_push(exprs, "2 summermed 3");
            nl_list_text_push(exprs, "2 summerer med 3");
            nl_list_text_push(exprs, "2 summerer_med 3");
            nl_list_text_push(exprs, "2 summerermed 3");
            nl_list_text_push(exprs, "2 summeres med 3");
            nl_list_text_push(exprs, "2 summeres_med 3");
            nl_list_text_push(exprs, "2 summeresmed 3");
            nl_list_text_push(exprs, "2 summer 3");
            nl_list_text_push(exprs, "10 trekk fra 3");
            nl_list_text_push(exprs, "10 trekk_fra 3");
            nl_list_text_push(exprs, "10 trekkfra 3");
            nl_list_text_push(exprs, "10 trekke_fra 3");
            nl_list_text_push(exprs, "10 trekkefra 3");
            nl_list_text_push(exprs, "10 trekkes fra 3");
            nl_list_text_push(exprs, "10 trekkes_fra 3");
            nl_list_text_push(exprs, "10 trekkesfra 3");
            nl_list_text_push(exprs, "10 minus fra 3");
            nl_list_text_push(exprs, "10 minus_fra 3");
            nl_list_text_push(exprs, "10 minusfra 3");
            nl_list_text_push(exprs, "10 minuseres fra 3");
            nl_list_text_push(exprs, "10 minuseres_fra 3");
            nl_list_text_push(exprs, "10 minuseresfra 3");
            nl_list_text_push(exprs, "10 subtraher fra 3");
            nl_list_text_push(exprs, "10 subtraher_fra 3");
            nl_list_text_push(exprs, "10 subtraherfra 3");
            nl_list_text_push(exprs, "10 subtraherer fra 3");
            nl_list_text_push(exprs, "10 subtraherer_fra 3");
            nl_list_text_push(exprs, "10 subtrahererfra 3");
            nl_list_text_push(exprs, "10 subtraheres fra 3");
            nl_list_text_push(exprs, "10 subtraheres_fra 3");
            nl_list_text_push(exprs, "10 subtraheresfra 3");
            nl_list_text_push(exprs, "10 subtrahert fra 3");
            nl_list_text_push(exprs, "10 subtrahert_fra 3");
            nl_list_text_push(exprs, "10 subtrahertfra 3");
            nl_list_text_push(exprs, "8 delt pa 2");
            nl_list_text_push(exprs, "17 mod 5");
            nl_list_text_push(exprs, "17 mod_av 5");
            nl_list_text_push(exprs, "17 modav 5");
            nl_list_text_push(exprs, "17 mod av 5");
            nl_list_text_push(exprs, "17 modulo 5");
            nl_list_text_push(exprs, "17 modulo_av 5");
            nl_list_text_push(exprs, "17 moduloav 5");
            nl_list_text_push(exprs, "17 modulo av 5");
            nl_list_text_push(exprs, "17 modul 5");
            nl_list_text_push(exprs, "17 modul_av 5");
            nl_list_text_push(exprs, "17 modulav 5");
            nl_list_text_push(exprs, "17 modul av 5");
            nl_list_text_push(exprs, "17 modulus 5");
            nl_list_text_push(exprs, "17 modulus_av 5");
            nl_list_text_push(exprs, "17 modulusav 5");
            nl_list_text_push(exprs, "17 modulus av 5");
            nl_list_text_push(exprs, "17 rest 5");
            nl_list_text_push(exprs, "17 resten 5");
            nl_list_text_push(exprs, "17 rest_av 5");
            nl_list_text_push(exprs, "17 restav 5");
            nl_list_text_push(exprs, "17 rest av 5");
            nl_list_text_push(exprs, "17 resten_av 5");
            nl_list_text_push(exprs, "17 restenav 5");
            nl_list_text_push(exprs, "17 resten av 5");
            nl_list_text_push(exprs, "3 ganget med 4");
            nl_list_text_push(exprs, "3 ganget_med 4");
            nl_list_text_push(exprs, "3 gange med 4");
            nl_list_text_push(exprs, "3 gange_med 4");
            nl_list_text_push(exprs, "3 gangemed 4");
            nl_list_text_push(exprs, "3 ganger med 4");
            nl_list_text_push(exprs, "3 ganger_med 4");
            nl_list_text_push(exprs, "3 gangermed 4");
            nl_list_text_push(exprs, "3 ganges med 4");
            nl_list_text_push(exprs, "3 ganges_med 4");
            nl_list_text_push(exprs, "3 gangesmed 4");
            nl_list_text_push(exprs, "3 gang med 4");
            nl_list_text_push(exprs, "3 gang_med 4");
            nl_list_text_push(exprs, "3 gangmed 4");
            nl_list_text_push(exprs, "3 gang 4");
            nl_list_text_push(exprs, "3 gange 4");
            nl_list_text_push(exprs, "3 ganget 4");
            nl_list_text_push(exprs, "3 ganger 4");
            nl_list_text_push(exprs, "3 ganges 4");
            nl_list_text_push(exprs, "3 multipliser med 4");
            nl_list_text_push(exprs, "3 multipliser_med 4");
            nl_list_text_push(exprs, "3 multiplisermed 4");
            nl_list_text_push(exprs, "3 multiplisere med 4");
            nl_list_text_push(exprs, "3 multiplisere_med 4");
            nl_list_text_push(exprs, "3 multipliseremed 4");
            nl_list_text_push(exprs, "3 multipliserer med 4");
            nl_list_text_push(exprs, "3 multipliserer_med 4");
            nl_list_text_push(exprs, "3 multipliserermed 4");
            nl_list_text_push(exprs, "3 multiplisert med 4");
            nl_list_text_push(exprs, "3 multiplisert_med 4");
            nl_list_text_push(exprs, "3 multiplisertmed 4");
            nl_list_text_push(exprs, "3 multipliseres med 4");
            nl_list_text_push(exprs, "3 multipliseres_med 4");
            nl_list_text_push(exprs, "3 multipliseresmed 4");
            nl_list_text_push(exprs, "3 multipliser 4");
            nl_list_text_push(exprs, "3 multiplisere 4");
            nl_list_text_push(exprs, "3 multipliserer 4");
            nl_list_text_push(exprs, "3 multiplisert 4");
            nl_list_text_push(exprs, "3 multipliseres 4");
            nl_list_text_push(exprs, "8 delt med 2");
            nl_list_text_push(exprs, "8 delt_med 2");
            nl_list_text_push(exprs, "8 deltmed 2");
            nl_list_text_push(exprs, "8 divider med 2");
            nl_list_text_push(exprs, "8 divider_med 2");
            nl_list_text_push(exprs, "8 dividermed 2");
            nl_list_text_push(exprs, "8 dividere med 2");
            nl_list_text_push(exprs, "8 dividere_med 2");
            nl_list_text_push(exprs, "8 divideremed 2");
            nl_list_text_push(exprs, "8 dele seg med 2");
            nl_list_text_push(exprs, "8 dele_seg_med 2");
            nl_list_text_push(exprs, "8 delesegmed 2");
            nl_list_text_push(exprs, "8 deler seg med 2");
            nl_list_text_push(exprs, "8 deler_seg_med 2");
            nl_list_text_push(exprs, "8 delersegmed 2");
            nl_list_text_push(exprs, "8 dele seg pa 2");
            nl_list_text_push(exprs, "8 dele seg på 2");
            nl_list_text_push(exprs, "8 dele seg paa 2");
            nl_list_text_push(exprs, "8 dele_seg_pa 2");
            nl_list_text_push(exprs, "8 delesegpa 2");
            nl_list_text_push(exprs, "8 delesegpaa 2");
            nl_list_text_push(exprs, "8 dele_seg_på 2");
            nl_list_text_push(exprs, "8 dele_seg_paa 2");
            nl_list_text_push(exprs, "8 deler seg pa 2");
            nl_list_text_push(exprs, "8 deler seg på 2");
            nl_list_text_push(exprs, "8 deler seg paa 2");
            nl_list_text_push(exprs, "8 deler_seg_pa 2");
            nl_list_text_push(exprs, "8 delersegpa 2");
            nl_list_text_push(exprs, "8 delersegpaa 2");
            nl_list_text_push(exprs, "8 deler_seg_på 2");
            nl_list_text_push(exprs, "8 deler_seg_paa 2");
            nl_list_text_push(exprs, "8 divider seg med 2");
            nl_list_text_push(exprs, "8 divider_seg_med 2");
            nl_list_text_push(exprs, "8 dividersegmed 2");
            nl_list_text_push(exprs, "8 divider seg pa 2");
            nl_list_text_push(exprs, "8 divider seg på 2");
            nl_list_text_push(exprs, "8 divider seg paa 2");
            nl_list_text_push(exprs, "8 divider_seg_pa 2");
            nl_list_text_push(exprs, "8 dividersegpa 2");
            nl_list_text_push(exprs, "8 dividersegpaa 2");
            nl_list_text_push(exprs, "8 divider_seg_på 2");
            nl_list_text_push(exprs, "8 divider_seg_paa 2");
            nl_list_text_push(exprs, "8 dividere seg med 2");
            nl_list_text_push(exprs, "8 dividere_seg_med 2");
            nl_list_text_push(exprs, "8 divideresegmed 2");
            nl_list_text_push(exprs, "8 dividere seg pa 2");
            nl_list_text_push(exprs, "8 dividere seg på 2");
            nl_list_text_push(exprs, "8 dividere seg paa 2");
            nl_list_text_push(exprs, "8 dividere_seg_pa 2");
            nl_list_text_push(exprs, "8 divideresegpa 2");
            nl_list_text_push(exprs, "8 divideresegpaa 2");
            nl_list_text_push(exprs, "8 dividere_seg_på 2");
            nl_list_text_push(exprs, "8 dividere_seg_paa 2");
            nl_list_text_push(exprs, "8 dividerer seg med 2");
            nl_list_text_push(exprs, "8 dividerer_seg_med 2");
            nl_list_text_push(exprs, "8 dividerersegmed 2");
            nl_list_text_push(exprs, "8 dividerer seg pa 2");
            nl_list_text_push(exprs, "8 dividerer seg på 2");
            nl_list_text_push(exprs, "8 dividerer seg paa 2");
            nl_list_text_push(exprs, "8 dividerer_seg_pa 2");
            nl_list_text_push(exprs, "8 dividerersegpa 2");
            nl_list_text_push(exprs, "8 dividerersegpaa 2");
            nl_list_text_push(exprs, "8 dividerer_seg_på 2");
            nl_list_text_push(exprs, "8 dividerer_seg_paa 2");
            nl_list_text_push(exprs, "8 dividerer med 2");
            nl_list_text_push(exprs, "8 dividerer_med 2");
            nl_list_text_push(exprs, "8 dividerermed 2");
            nl_list_text_push(exprs, "8 dividert med 2");
            nl_list_text_push(exprs, "8 dividert_med 2");
            nl_list_text_push(exprs, "8 dividertmed 2");
            nl_list_text_push(exprs, "8 divideres med 2");
            nl_list_text_push(exprs, "8 divideres_med 2");
            nl_list_text_push(exprs, "8 divideresmed 2");
            nl_list_text_push(exprs, "8 deles med 2");
            nl_list_text_push(exprs, "8 deles_med 2");
            nl_list_text_push(exprs, "8 delesmed 2");
            nl_list_text_push(exprs, "8 del med 2");
            nl_list_text_push(exprs, "8 del_med 2");
            nl_list_text_push(exprs, "8 delmed 2");
            nl_list_text_push(exprs, "8 dele med 2");
            nl_list_text_push(exprs, "8 dele_med 2");
            nl_list_text_push(exprs, "8 delemed 2");
            nl_list_text_push(exprs, "8 dele på 2");
            nl_list_text_push(exprs, "8 dele pa 2");
            nl_list_text_push(exprs, "8 dele_pa 2");
            nl_list_text_push(exprs, "8 delepa 2");
            nl_list_text_push(exprs, "8 delepaa 2");
            nl_list_text_push(exprs, "8 del på 2");
            nl_list_text_push(exprs, "8 del_på 2");
            nl_list_text_push(exprs, "8 del_pa 2");
            nl_list_text_push(exprs, "8 delpa 2");
            nl_list_text_push(exprs, "8 delpaa 2");
            nl_list_text_push(exprs, "8 del paa 2");
            nl_list_text_push(exprs, "8 del_paa 2");
            nl_list_text_push(exprs, "8 deles på 2");
            nl_list_text_push(exprs, "8 deles_på 2");
            nl_list_text_push(exprs, "8 deles_pa 2");
            nl_list_text_push(exprs, "8 delespa 2");
            nl_list_text_push(exprs, "8 delespaa 2");
            nl_list_text_push(exprs, "8 deles paa 2");
            nl_list_text_push(exprs, "8 deles_paa 2");
            nl_list_text_push(exprs, "8 divider på 2");
            nl_list_text_push(exprs, "8 divider_pa 2");
            nl_list_text_push(exprs, "8 dividerpa 2");
            nl_list_text_push(exprs, "8 dividerpaa 2");
            nl_list_text_push(exprs, "8 dividere på 2");
            nl_list_text_push(exprs, "8 dividere_pa 2");
            nl_list_text_push(exprs, "8 dividerepa 2");
            nl_list_text_push(exprs, "8 dividerepaa 2");
            nl_list_text_push(exprs, "8 dividerer på 2");
            nl_list_text_push(exprs, "8 dividerer_pa 2");
            nl_list_text_push(exprs, "8 dividererpa 2");
            nl_list_text_push(exprs, "8 dividererpaa 2");
            nl_list_text_push(exprs, "8 dividert på 2");
            nl_list_text_push(exprs, "8 dividert_pa 2");
            nl_list_text_push(exprs, "8 dividertpa 2");
            nl_list_text_push(exprs, "8 dividertpaa 2");
            nl_list_text_push(exprs, "8 divideres på 2");
            nl_list_text_push(exprs, "8 divideres_på 2");
            nl_list_text_push(exprs, "8 divideres_pa 2");
            nl_list_text_push(exprs, "8 dividerespa 2");
            nl_list_text_push(exprs, "8 dividerespaa 2");
            nl_list_text_push(exprs, "8 divideres paa 2");
            nl_list_text_push(exprs, "8 divideres_paa 2");
            nl_list_text_push(exprs, "8 delt på 2");
            nl_list_text_push(exprs, "8 delt_på 2");
            nl_list_text_push(exprs, "8 delt_pa 2");
            nl_list_text_push(exprs, "8 deltpa 2");
            nl_list_text_push(exprs, "8 deltpaa 2");
            nl_list_text_push(exprs, "8 delt paa 2");
            nl_list_text_push(exprs, "8 delt_paa 2");
            nl_list_text_push(exprs, "8 deler pa 2");
            nl_list_text_push(exprs, "8 deler_på 2");
            nl_list_text_push(exprs, "8 deler med 2");
            nl_list_text_push(exprs, "8 deler_pa 2");
            nl_list_text_push(exprs, "8 delerpa 2");
            nl_list_text_push(exprs, "8 delerpaa 2");
            nl_list_text_push(exprs, "8 deler_med 2");
            nl_list_text_push(exprs, "8 dele 2");
            nl_list_text_push(exprs, "8 deler 2");
            nl_list_text_push(exprs, "8 divider 2");
            nl_list_text_push(exprs, "8 dividere 2");
            nl_list_text_push(exprs, "sann&&usann||!usann");
            nl_list_text_push(exprs, "sant&&usann");
            nl_list_text_push(exprs, "sant&&usant");
            nl_list_text_push(exprs, "ja&&nei");
            nl_list_text_push(exprs, "true&&false");
            nl_list_text_push(exprs, "sann og ikke usann eller usann");
            nl_list_text_push(exprs, "usann enten sann");
            nl_list_text_push(exprs, "sann og ikkje usann");
            nl_list_text_push(exprs, "sann samt ikke usann");
            nl_list_text_push(exprs, "7 er 7 og 3 mindre_enn 4");
            nl_list_text_push(exprs, "7 ikke_er 8 og 4 storre_eller_lik 4");
            nl_list_text_push(exprs, "7 er 7 og 3 mindre enn 4");
            nl_list_text_push(exprs, "7 ikke er 8 og 4 storre eller lik 4");
            nl_list_text_push(exprs, "7 er ikke 8 og 4 storre eller lik 4");
            nl_list_text_push(exprs, "7 er lik 7 og 3 mindre enn 4");
            nl_list_text_push(exprs, "7 er ikke lik 8 og 4 storre eller lik 4");
            nl_list_text_push(exprs, "3 er mindre enn 4");
            nl_list_text_push(exprs, "3 er_mindre_enn 4");
            nl_list_text_push(exprs, "3 er_mindre_eller_lik 4");
            nl_list_text_push(exprs, "3 ermindreellerlik 4");
            nl_list_text_push(exprs, "3 er_mindre_enn_eller_lik 4");
            nl_list_text_push(exprs, "4 er storre eller lik 4");
            nl_list_text_push(exprs, "4 er_storre_eller_lik 4");
            nl_list_text_push(exprs, "4 er_større_eller_lik 4");
            nl_list_text_push(exprs, "4 erstorrelik 4");
            nl_list_text_push(exprs, "4 erstørrelik 4");
            nl_list_text_push(exprs, "4 erstorreellerlik 4");
            nl_list_text_push(exprs, "4 erstørreellerlik 4");
            nl_list_text_push(exprs, "4 er_storre_enn 3");
            nl_list_text_push(exprs, "4 er_større_enn 3");
            nl_list_text_push(exprs, "4 erstorreenn 3");
            nl_list_text_push(exprs, "4 erstørreenn 3");
            nl_list_text_push(exprs, "4 er_storre_enn_eller_lik 4");
            nl_list_text_push(exprs, "4 er_større_enn_eller_lik 4");
            nl_list_text_push(exprs, "4 erstorreennellerlik 4");
            nl_list_text_push(exprs, "4 erstørreennellerlik 4");
            nl_list_text_push(exprs, "7 ikke lik 8");
            nl_list_text_push(exprs, "7 ulik 8");
            nl_list_text_push(exprs, "7 er ulik 8");
            nl_list_text_push(exprs, "7 er_ulik 8");
            nl_list_text_push(exprs, "4 storre enn eller lik 4");
            nl_list_text_push(exprs, "4 er storre enn eller lik 4");
            nl_list_text_push(exprs, "7 er lik med 7");
            nl_list_text_push(exprs, "7 er_lik_med 7");
            nl_list_text_push(exprs, "7 er_lik 7");
            nl_list_text_push(exprs, "7 lik_med 7");
            nl_list_text_push(exprs, "7 likmed 7");
            nl_list_text_push(exprs, "7 ikke lik med 8");
            nl_list_text_push(exprs, "7 ikke_lik_med 8");
            nl_list_text_push(exprs, "7 ikkelikmed 8");
            nl_list_text_push(exprs, "7 ikke_lik 8");
            nl_list_text_push(exprs, "7 er ikke lik med 8");
            nl_list_text_push(exprs, "7 lik 7");
            nl_list_text_push(exprs, "7 ulik med 8");
            nl_list_text_push(exprs, "7 ulik_med 8");
            nl_list_text_push(exprs, "7 ulikmed 8");
            nl_list_text_push(exprs, "3 mindre lik 4");
            nl_list_text_push(exprs, "4 storre lik 4");
            nl_list_text_push(exprs, "4 storre_lik 4");
            nl_list_text_push(exprs, "4 storrelik 4");
            nl_list_text_push(exprs, "4 større_lik 4");
            nl_list_text_push(exprs, "4 størrelik 4");
            nl_list_text_push(exprs, "4 er storre lik 4");
            nl_list_text_push(exprs, "4 er større enn eller lik 4");
            nl_list_text_push(exprs, "4 større_enn_eller_lik 4");
            nl_list_text_push(exprs, "4 større_enn 3");
            nl_list_text_push(exprs, "4 storreenn 3");
            nl_list_text_push(exprs, "4 størreenn 3");
            nl_list_text_push(exprs, "4 større_eller_lik 4");
            nl_list_text_push(exprs, "4 størreellerlik 4");
            nl_list_text_push(exprs, "4 storreellerlik 4");
            nl_list_text_push(exprs, "4 storre_enn_eller_lik 4");
            nl_list_text_push(exprs, "3 mindre_enn_eller_lik 4");
            nl_list_text_push(exprs, "3 mindreennellerlik 4");
            nl_list_text_push(exprs, "3 ermindreennellerlik 4");
            nl_list_text_push(exprs, "3 ermindreenn 4");
            nl_list_text_push(exprs, "3 mindreenn 4");
            nl_list_text_push(exprs, "3 mindre_lik 4");
            nl_list_text_push(exprs, "3 ermindrelik 4");
            nl_list_text_push(exprs, "3 mindreellerlik 4");
            nl_list_text_push(exprs, "3 mindrelik 4");
            nl_list_text_push(exprs, "3 mindre enn lik 4");
            nl_list_text_push(exprs, "7 er_ikke 8");
            nl_list_text_push(exprs, "7 erikke 8");
            nl_list_text_push(exprs, "7 ikkje_er 8");
            nl_list_text_push(exprs, "7 ikkje_lik 8");
            nl_list_text_push(exprs, "7 ikkje_lik_med 8");
            nl_list_text_push(exprs, "7 ikkjelikmed 8");
            nl_list_text_push(exprs, "7 er_ulik_med 8");
            nl_list_text_push(exprs, "7 erlikmed 7");
            nl_list_text_push(exprs, "7 erulikmed 8");
            nl_list_text_push(exprs, "7 erikkelikmed 8");
            nl_list_text_push(exprs, "7 er_ikkje 8");
            nl_list_text_push(exprs, "7 erlik 7");
            nl_list_text_push(exprs, "7 erulik 8");
            nl_list_text_push(exprs, "7 erikkje 8");
            nl_list_text_push(exprs, "7 erikkelik 8");
            nl_list_text_push(exprs, "7 erikkjelik 8");
            nl_list_text_push(exprs, "7 erikkjelikmed 8");
            nl_list_text_push(exprs, "7 er ikkje 8");
            nl_list_text_push(exprs, "7 ikkje lik 8");
            nl_list_text_push(exprs, "4 er storre enn lik 4");
            nl_list_text_push(exprs, "hvis 1==1 da 7 ellers 9");
            nl_list_text_push(exprs, "hvis 0==1 da 10 ellers_hvis 1==1 da 20 ellers 30");
            nl_list_text_push(exprs, "hvis 0==1 da 10 elif 1==1 da 20 ellers 30");
            nl_list_text_push(exprs, "if 1==1 then 7 else 9");
            nl_list_text_push(exprs, "if 0==1 then 10 elseif 1==1 then 20 else 30");
            nl_list_text_push(exprs, "if 0==1 then 10 elsif 1==1 then 20 else 30");
            nl_list_text_push(exprs, "not 0 and 1 or 0");
            nl_list_text_push(exprs, "4 greater_or_equal 4 and 3 less_than 4");
            nl_list_text_push(exprs, "7 is_not 8");
            nl_list_text_push(exprs, "7 eq 7");
            nl_list_text_push(exprs, "7 neq 8");
            nl_list_text_push(exprs, "on and not off");
            nl_list_text_push(exprs, "yes and not no");
            nl_list_text_push(exprs, "enabled and not disabled");
            nl_list_text_push(exprs, "active and not inactive");
            nl_list_text_push(exprs, "truthy and not falsy");
            nl_list_text_push(exprs, "affirmative and not negative");
            nl_list_text_push(exprs, "affirm and not deny");
            nl_list_text_push(exprs, "approved and not rejected");
            nl_list_text_push(exprs, "accepted and not declined");
            nl_list_text_push(exprs, "confirmed and not denied");
            nl_list_text_push(exprs, "pass and not fail");
            nl_list_text_push(exprs, "success and not failure");
            nl_list_text_push(exprs, "allow and not block");
            nl_list_text_push(exprs, "permit and not forbid");
            nl_list_text_push(exprs, "valid and not invalid");
            nl_list_text_push(exprs, "ok and not not_ok");
            nl_list_text_push(exprs, "ready and not not_ready");
            nl_list_text_push(exprs, "safe and not unsafe");
            nl_list_text_push(exprs, "secure and not insecure");
            nl_list_text_push(exprs, "trusted and not untrusted");
            nl_list_text_push(exprs, "open and not closed");
            nl_list_text_push(exprs, "public and not private");
            nl_list_text_push(exprs, "visible and not hidden");
            nl_list_text_push(exprs, "present and not absent");
            nl_list_text_push(exprs, "online and not offline");
            nl_list_text_push(exprs, "connected and not disconnected");
            nl_list_text_push(exprs, "available and not unavailable");
            nl_list_text_push(exprs, "reachable and not unreachable");
            nl_list_text_push(exprs, "working and not broken");
            nl_list_text_push(exprs, "stable and not unstable");
            nl_list_text_push(exprs, "correct and not incorrect");
            nl_list_text_push(exprs, "complete and not incomplete");
            nl_list_text_push(exprs, "clean and not dirty");
            nl_list_text_push(exprs, "up and not down");
            nl_list_text_push(exprs, "alive and not dead");
            nl_list_text_push(exprs, "awake and not asleep");
            nl_list_text_push(exprs, "healthy and not unhealthy");
            nl_list_text_push(exprs, "synced and not unsynced");
            nl_list_text_push(exprs, "7 equal_to 7");
            nl_list_text_push(exprs, "7 equal to 7");
            nl_list_text_push(exprs, "7 is equal to 7");
            nl_list_text_push(exprs, "7 is_equal_to 7");
            nl_list_text_push(exprs, "7 not_equal_to 8");
            nl_list_text_push(exprs, "7 not equal to 8");
            nl_list_text_push(exprs, "7 is not equal to 8");
            nl_list_text_push(exprs, "7 is_not_equal_to 8");
            nl_list_text_push(exprs, "7 isnt 8");
            nl_list_text_push(exprs, "3 less_equal 4");
            nl_list_text_push(exprs, "4 greater_equal 4");
            nl_list_text_push(exprs, "3 less than 4");
            nl_list_text_push(exprs, "4 greater than 3");
            nl_list_text_push(exprs, "3 is less than 4");
            nl_list_text_push(exprs, "4 is greater than 3");
            nl_list_text_push(exprs, "3 less than or equal 3");
            nl_list_text_push(exprs, "3 less than or equal to 3");
            nl_list_text_push(exprs, "4 greater than or equal 4");
            nl_list_text_push(exprs, "4 greater than or equal to 4");
            nl_list_text_push(exprs, "3 is less than or equal to 3");
            nl_list_text_push(exprs, "4 is greater than or equal to 4");
            nl_list_text_push(exprs, "3 is less or equal 3");
            nl_list_text_push(exprs, "3 is less or equal to 3");
            nl_list_text_push(exprs, "4 is greater or equal 4");
            nl_list_text_push(exprs, "4 is greater or equal to 4");
            nl_list_text_push(exprs, "3 is_less_than 4");
            nl_list_text_push(exprs, "4 is_greater_or_equal 4");
            nl_list_text_push(exprs, "3 is_less_than_or_equal_to 3");
            nl_list_text_push(exprs, "4 is_greater_than_or_equal_to 4");
            nl_list_text_push(exprs, "3 is_less_or_equal_to 3");
            nl_list_text_push(exprs, "4 is_greater_or_equal_to 4");
            nl_list_text_push(exprs, "3 times 4");
            nl_list_text_push(exprs, "3 multiplied_by 4");
            nl_list_text_push(exprs, "3 multiply by 4");
            nl_list_text_push(exprs, "3 multiplied by 4");
            nl_list_text_push(exprs, "8 divided_by 2");
            nl_list_text_push(exprs, "8 divided by 2");
            nl_list_text_push(exprs, "8 divide by 2");
            nl_list_text_push(exprs, "3 add 4");
            nl_list_text_push(exprs, "10 subtract 3");
            nl_list_text_push(exprs, "8 divide 2");
            nl_list_text_push(exprs, "17 mod_of 5");
            nl_list_text_push(exprs, "17 modulo of 5");
            nl_list_text_push(exprs, "17 remainder 5");
            nl_list_text_push(exprs, "17 remainder of 5");
            nl_list_text_push(exprs, "2 +");
            nl_list_text_push(exprs, "2 + )");
            nl_list_text_push(exprs, "2+$");
            nl_list_text_push(exprs, "foo+1");
            nl_list_text_push(exprs, "(2+3");
            int i = 0;
            int n = nl_list_text_len(exprs);
            while (i < n) {
                char * res = selfhost__compiler__disasm_uttrykk(exprs->data[i]);
                char * idx = nl_int_to_text((i + 1));
                nl_print_text(nl_concat(nl_concat("-- ", idx), " --"));
                nl_print_text(exprs->data[i]);
                nl_print_text(res);
                i = (i + 1);
            }
            return 0;
