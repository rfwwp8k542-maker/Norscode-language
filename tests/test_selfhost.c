...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        if ((((((((((((((((((((((((((((((nl_streq(tok_raw, "delt_pa") || nl_streq(tok_raw, "deltpa")) || nl_streq(tok_raw, "deler_pa")) || nl_streq(tok_raw, "delerpa")) || nl_streq(tok_raw, "dele_pa")) || nl_streq(tok_raw, "delepa")) || nl_streq(tok_raw, "delepaa")) || nl_streq(tok_raw, "deles_pa")) || nl_streq(tok_raw, "delespa")) || nl_streq(tok_raw, "del_pa")) || nl_streq(tok_raw, "delpa")) || nl_streq(tok_raw, "dele_seg_pa")) || nl_streq(tok_raw, "delesegpa")) || nl_streq(tok_raw, "deler_seg_pa")) || nl_streq(tok_raw, "delersegpa")) || nl_streq(tok_raw, "divider_seg_pa")) || nl_streq(tok_raw, "dividersegpa")) || nl_streq(tok_raw, "dividere_seg_pa")) || nl_streq(tok_raw, "divideresegpa")) || nl_streq(tok_raw, "dividerer_seg_pa")) || nl_streq(tok_raw, "dividerersegpa")) || nl_streq(tok_raw, "divider_pa")) || nl_streq(tok_raw, "dividerpa")) || nl_streq(tok_raw, "dividere_pa")) || nl_streq(tok_raw, "dividerepa")) || nl_streq(tok_raw, "dividerer_pa")) || nl_streq(tok_raw, "dividererpa")) || nl_streq(tok_raw, "dividert_pa")) || nl_streq(tok_raw, "dividertpa")) || nl_streq(tok_raw, "divideres_pa")) || nl_streq(tok_raw, "dividerespa")) {
            tok = "/";
            tok_step = 1;
        }
        else if (((((((((((((((((((((((nl_streq(tok_raw, "delt_med") || nl_streq(tok_raw, "deltmed")) || nl_streq(tok_raw, "dele_med")) || nl_streq(tok_raw, "delemed")) || nl_streq(tok_raw, "deler_med")) || nl_streq(tok_raw, "deles_med")) || nl_streq(tok_raw, "delesmed")) || nl_streq(tok_raw, "dele_seg_med")) || nl_streq(tok_raw, "deler_seg_med")) || nl_streq(tok_raw, "divider_seg_med")) || nl_streq(tok_raw, "dividere_seg_med")) || nl_streq(tok_raw, "dividerer_seg_med")) || nl_streq(tok_raw, "dividere_med")) || nl_streq(tok_raw, "divideremed")) || nl_streq(tok_raw, "divider_med")) || nl_streq(tok_raw, "dividermed")) || nl_streq(tok_raw, "dividerer_med")) || nl_streq(tok_raw, "dividerermed")) || nl_streq(tok_raw, "dividert_med")) || nl_streq(tok_raw, "dividertmed")) || nl_streq(tok_raw, "divideres_med")) || nl_streq(tok_raw, "divideresmed")) || nl_streq(tok_raw, "del_med")) || nl_streq(tok_raw, "delmed")) {
            tok = "/";
            tok_step = 1;
        }
