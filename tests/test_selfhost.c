...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        if (((((((nl_streq(tok_raw, "delt_pa") || nl_streq(tok_raw, "deler_pa")) || nl_streq(tok_raw, "dele_pa")) || nl_streq(tok_raw, "deles_pa")) || nl_streq(tok_raw, "divider_pa")) || nl_streq(tok_raw, "dividerer_pa")) || nl_streq(tok_raw, "dividert_pa")) || nl_streq(tok_raw, "divideres_pa")) {
            tok = "/";
            tok_step = 1;
        }
        ...
        else if ((((i + 1) < nl_list_text_len(tokens)) && (((((((nl_streq(tok_raw, "delt") || nl_streq(tok_raw, "deler")) || nl_streq(tok_raw, "dele")) || nl_streq(tok_raw, "deles")) || nl_streq(tok_raw, "divider")) || nl_streq(tok_raw, "dividerer")) || nl_streq(tok_raw, "dividert")) || nl_streq(tok_raw, "divideres"))) && (nl_streq(n1, "pa") || nl_streq(n1, "paa"))) {
            tok = "/";
            tok_step = 2;
        }
        ...
        else if ((((((((nl_streq(tok_raw, "gang_med") || nl_streq(tok_raw, "ganget_med")) || nl_streq(tok_raw, "gange_med")) || nl_streq(tok_raw, "ganger_med")) || nl_streq(tok_raw, "ganges_med")) || nl_streq(tok_raw, "multipliser_med")) || nl_streq(tok_raw, "multipliserer_med")) || nl_streq(tok_raw, "multiplisert_med")) || nl_streq(tok_raw, "multipliseres_med")) {
            tok = "*";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((((((((nl_streq(tok_raw, "gang") || nl_streq(tok_raw, "ganget")) || nl_streq(tok_raw, "gange")) || nl_streq(tok_raw, "ganger")) || nl_streq(tok_raw, "ganges")) || nl_streq(tok_raw, "multipliser")) || nl_streq(tok_raw, "multipliserer")) || nl_streq(tok_raw, "multiplisert")) || nl_streq(tok_raw, "multipliseres"))) && nl_streq(n1, "med")) {
            tok = "*";
            tok_step = 2;
        }
        else if (nl_streq(tok_raw, "pluss_med") || nl_streq(tok_raw, "plus_med")) {
            tok = "+";
            tok_step = 1;
        }
        ...
        else if ((((((((nl_streq(tok_raw, "plusser_med") || nl_streq(tok_raw, "plusses_med")) || nl_streq(tok_raw, "pluses_med")) || nl_streq(tok_raw, "adder_med")) || nl_streq(tok_raw, "adderer_med")) || nl_streq(tok_raw, "adderes_med")) || nl_streq(tok_raw, "summer_med")) || nl_streq(tok_raw, "summerer_med")) || nl_streq(tok_raw, "summeres_med")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((((((((nl_streq(tok_raw, "plusser") || nl_streq(tok_raw, "plusses")) || nl_streq(tok_raw, "pluses")) || nl_streq(tok_raw, "adder")) || nl_streq(tok_raw, "adderer")) || nl_streq(tok_raw, "adderes")) || nl_streq(tok_raw, "summer")) || nl_streq(tok_raw, "summerer")) || nl_streq(tok_raw, "summeres"))) && nl_streq(n1, "med")) {
            tok = "+";
            tok_step = 2;
        }
