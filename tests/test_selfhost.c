...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        if ((((((((((((((nl_streq(tok_raw, "delt_pa") || nl_streq(tok_raw, "deler_pa")) || nl_streq(tok_raw, "dele_pa")) || nl_streq(tok_raw, "deles_pa")) || nl_streq(tok_raw, "del_pa")) || nl_streq(tok_raw, "dele_seg_pa")) || nl_streq(tok_raw, "deler_seg_pa")) || nl_streq(tok_raw, "divider_seg_pa")) || nl_streq(tok_raw, "dividere_seg_pa")) || nl_streq(tok_raw, "dividerer_seg_pa")) || nl_streq(tok_raw, "divider_pa")) || nl_streq(tok_raw, "dividere_pa")) || nl_streq(tok_raw, "dividerer_pa")) || nl_streq(tok_raw, "dividert_pa")) || nl_streq(tok_raw, "divideres_pa")) {
            tok = "/";
            tok_step = 1;
        }
        else if ((((((((((((((nl_streq(tok_raw, "delt_med") || nl_streq(tok_raw, "dele_med")) || nl_streq(tok_raw, "deler_med")) || nl_streq(tok_raw, "deles_med")) || nl_streq(tok_raw, "dele_seg_med")) || nl_streq(tok_raw, "deler_seg_med")) || nl_streq(tok_raw, "divider_seg_med")) || nl_streq(tok_raw, "dividere_seg_med")) || nl_streq(tok_raw, "dividerer_seg_med")) || nl_streq(tok_raw, "dividere_med")) || nl_streq(tok_raw, "divider_med")) || nl_streq(tok_raw, "dividerer_med")) || nl_streq(tok_raw, "dividert_med")) || nl_streq(tok_raw, "divideres_med")) || nl_streq(tok_raw, "del_med")) {
            tok = "/";
            tok_step = 1;
        }
        ...
        else if ((((((((((nl_streq(tok_raw, "plusser_med") || nl_streq(tok_raw, "plusses_med")) || nl_streq(tok_raw, "pluses_med")) || nl_streq(tok_raw, "plusse_med")) || nl_streq(tok_raw, "adder_med")) || nl_streq(tok_raw, "addere_med")) || nl_streq(tok_raw, "adderer_med")) || nl_streq(tok_raw, "adderes_med")) || nl_streq(tok_raw, "summer_med")) || nl_streq(tok_raw, "summerer_med")) || nl_streq(tok_raw, "summeres_med")) {
            tok = "+";
            tok_step = 1;
        }
        ...
        else if ((nl_streq(tok_raw, "legg_til") || nl_streq(tok_raw, "legge_til")) || nl_streq(tok_raw, "legges_til")) {
            tok = "+";
            tok_step = 1;
        }
        ...
        else if ((nl_streq(tok_raw, "legg_sammen") || nl_streq(tok_raw, "legge_sammen")) || nl_streq(tok_raw, "legges_sammen")) {
            tok = "+";
            tok_step = 1;
        }
        ...
        else if (((((((((((((nl_streq(tok_raw, "mod") || nl_streq(tok_raw, "mod_av")) || nl_streq(tok_raw, "modulo")) || nl_streq(tok_raw, "modulo_av")) || nl_streq(tok_raw, "moduloav")) || nl_streq(tok_raw, "modul")) || nl_streq(tok_raw, "modul_av")) || nl_streq(tok_raw, "modulus")) || nl_streq(tok_raw, "modulus_av")) || nl_streq(tok_raw, "modulusav")) || nl_streq(tok_raw, "rest")) || nl_streq(tok_raw, "rest_av")) || nl_streq(tok_raw, "resten")) || nl_streq(tok_raw, "resten_av")) {
            tok = "%";
            tok_step = 1;
        }
