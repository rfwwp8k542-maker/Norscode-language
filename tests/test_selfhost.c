...
char * selfhost__compiler__normaliser_norsk_token(char * tok) {
    ...
    if (nl_streq(tok, "er_større_enn") || nl_streq(tok, "er_storre_enn")) {
        return "storre_enn";
    }
    if (nl_streq(tok, "større_eller_lik")) {
        return "storre_eller_lik";
    }
    if (nl_streq(tok, "større_lik") || nl_streq(tok, "storre_lik")) {
        return "storre_eller_lik";
    }
    ...
    if (nl_streq(tok, "er_større_enn_eller_lik") || nl_streq(tok, "er_storre_enn_eller_lik")) {
        return "storre_eller_lik";
    }
    if (nl_streq(tok, "er_mindre_enn")) {
        return "mindre_enn";
    }
    if (nl_streq(tok, "er_mindre_eller_lik") || nl_streq(tok, "er_mindre_enn_eller_lik")) {
    ...
    if (((((((((nl_streq(tok, "ikke_lik") || nl_streq(tok, "ikke_lik_med")) || nl_streq(tok, "er_ikke")) || nl_streq(tok, "er_ulik")) || nl_streq(tok, "er_ulik_med")) || nl_streq(tok, "ulik_med")) || nl_streq(tok, "ikkje_lik")) || nl_streq(tok, "ikkje_lik_med")) || nl_streq(tok, "ikkje_er")) || nl_streq(tok, "er_ikkje")) {
        return "ikke_er";
    }
...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        if (((nl_streq(tok_raw, "delt_pa") || nl_streq(tok_raw, "deler_pa")) || nl_streq(tok_raw, "dele_pa")) || nl_streq(tok_raw, "deles_pa")) {
            tok = "/";
            tok_step = 1;
        }
        else if ((((((((nl_streq(tok_raw, "delt_med") || nl_streq(tok_raw, "dele_med")) || nl_streq(tok_raw, "deler_med")) || nl_streq(tok_raw, "deles_med")) || nl_streq(tok_raw, "divider_med")) || nl_streq(tok_raw, "dividerer_med")) || nl_streq(tok_raw, "dividert_med")) || nl_streq(tok_raw, "divideres_med")) || nl_streq(tok_raw, "del_med")) {
            tok = "/";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && (((nl_streq(tok_raw, "delt") || nl_streq(tok_raw, "deler")) || nl_streq(tok_raw, "dele")) || nl_streq(tok_raw, "deles"))) && (nl_streq(n1, "pa") || nl_streq(n1, "paa"))) {
            tok = "/";
            tok_step = 2;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((((((((nl_streq(tok_raw, "delt") || nl_streq(tok_raw, "dele")) || nl_streq(tok_raw, "deler")) || nl_streq(tok_raw, "deles")) || nl_streq(tok_raw, "divider")) || nl_streq(tok_raw, "dividerer")) || nl_streq(tok_raw, "dividert")) || nl_streq(tok_raw, "divideres")) || nl_streq(tok_raw, "del"))) && nl_streq(n1, "med")) {
            tok = "/";
            tok_step = 2;
        }
        else if (((((((nl_streq(tok_raw, "ganget_med") || nl_streq(tok_raw, "gange_med")) || nl_streq(tok_raw, "ganger_med")) || nl_streq(tok_raw, "ganges_med")) || nl_streq(tok_raw, "multipliser_med")) || nl_streq(tok_raw, "multipliserer_med")) || nl_streq(tok_raw, "multiplisert_med")) || nl_streq(tok_raw, "multipliseres_med")) {
            tok = "*";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && (((((((nl_streq(tok_raw, "ganget") || nl_streq(tok_raw, "gange")) || nl_streq(tok_raw, "ganger")) || nl_streq(tok_raw, "ganges")) || nl_streq(tok_raw, "multipliser")) || nl_streq(tok_raw, "multipliserer")) || nl_streq(tok_raw, "multiplisert")) || nl_streq(tok_raw, "multipliseres"))) && nl_streq(n1, "med")) {
            tok = "*";
            tok_step = 2;
        }
        else if (nl_streq(tok_raw, "pluss_med")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && nl_streq(tok_raw, "pluss")) && nl_streq(n1, "med")) {
            tok = "+";
            tok_step = 2;
        }
        else if (nl_streq(tok_raw, "pluss")) {
            tok = "+";
            tok_step = 1;
        }
        else if (((((((nl_streq(tok_raw, "plusser_med") || nl_streq(tok_raw, "plusses_med")) || nl_streq(tok_raw, "adder_med")) || nl_streq(tok_raw, "adderer_med")) || nl_streq(tok_raw, "adderes_med")) || nl_streq(tok_raw, "summer_med")) || nl_streq(tok_raw, "summerer_med")) || nl_streq(tok_raw, "summeres_med")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && (((((((nl_streq(tok_raw, "plusser") || nl_streq(tok_raw, "plusses")) || nl_streq(tok_raw, "adder")) || nl_streq(tok_raw, "adderer")) || nl_streq(tok_raw, "adderes")) || nl_streq(tok_raw, "summer")) || nl_streq(tok_raw, "summerer")) || nl_streq(tok_raw, "summeres"))) && nl_streq(n1, "med")) {
            tok = "+";
            tok_step = 2;
        }
        else if (nl_streq(tok_raw, "legg_til") || nl_streq(tok_raw, "legges_til")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && (nl_streq(tok_raw, "legg") || nl_streq(tok_raw, "legges"))) && nl_streq(n1, "til")) {
            tok = "+";
            tok_step = 2;
        }
        else if (nl_streq(tok_raw, "legg_sammen") || nl_streq(tok_raw, "legges_sammen")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && (nl_streq(tok_raw, "legg") || nl_streq(tok_raw, "legges"))) && nl_streq(n1, "sammen")) {
            tok = "+";
            tok_step = 2;
        }
        ...
        else if ((((nl_streq(tok_raw, "minus_med") || nl_streq(tok_raw, "minuseres_med")) || nl_streq(tok_raw, "subtraher_med")) || nl_streq(tok_raw, "subtraherer_med")) || nl_streq(tok_raw, "subtraheres_med")) {
            tok = "-";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((((nl_streq(tok_raw, "minus") || nl_streq(tok_raw, "minuseres")) || nl_streq(tok_raw, "subtraher")) || nl_streq(tok_raw, "subtraherer")) || nl_streq(tok_raw, "subtraheres"))) && nl_streq(n1, "med")) {
            tok = "-";
            tok_step = 2;
        }
        ...
        else if (((nl_streq(tok_raw, "mod") || nl_streq(tok_raw, "modulo")) || nl_streq(tok_raw, "rest")) || nl_streq(tok_raw, "resten_av")) {
            tok = "%";
            tok_step = 1;
        }
