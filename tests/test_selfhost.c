...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        else if (((((nl_streq(tok_raw, "delt_med") || nl_streq(tok_raw, "dele_med")) || nl_streq(tok_raw, "deler_med")) || nl_streq(tok_raw, "divider_med")) || nl_streq(tok_raw, "dividerer_med")) || nl_streq(tok_raw, "del_med")) {
            tok = "/";
            tok_step = 1;
        }
        ...
        else if ((((i + 1) < nl_list_text_len(tokens)) && (((((nl_streq(tok_raw, "delt") || nl_streq(tok_raw, "dele")) || nl_streq(tok_raw, "deler")) || nl_streq(tok_raw, "divider")) || nl_streq(tok_raw, "dividerer")) || nl_streq(tok_raw, "del"))) && nl_streq(n1, "med")) {
            tok = "/";
            tok_step = 2;
        }
        else if ((((nl_streq(tok_raw, "ganget_med") || nl_streq(tok_raw, "gange_med")) || nl_streq(tok_raw, "ganger_med")) || nl_streq(tok_raw, "multipliser_med")) || nl_streq(tok_raw, "multipliserer_med")) {
            tok = "*";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((((nl_streq(tok_raw, "ganget") || nl_streq(tok_raw, "gange")) || nl_streq(tok_raw, "ganger")) || nl_streq(tok_raw, "multipliser")) || nl_streq(tok_raw, "multipliserer"))) && nl_streq(n1, "med")) {
            tok = "*";
            tok_step = 2;
        }
        ...
        else if ((nl_streq(tok_raw, "plusser_med") || nl_streq(tok_raw, "adder_med")) || nl_streq(tok_raw, "adderer_med")) {
            tok = "+";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((nl_streq(tok_raw, "plusser") || nl_streq(tok_raw, "adder")) || nl_streq(tok_raw, "adderer"))) && nl_streq(n1, "med")) {
            tok = "+";
            tok_step = 2;
        }
        ...
        else if ((((i + 1) < nl_list_text_len(tokens)) && (nl_streq(tok_raw, "trekk") || nl_streq(tok_raw, "trekke"))) && nl_streq(n1, "fra")) {
            tok = "-";
            tok_step = 2;
        }
        else if ((nl_streq(tok_raw, "minus_med") || nl_streq(tok_raw, "subtraher_med")) || nl_streq(tok_raw, "subtraherer_med")) {
            tok = "-";
            tok_step = 1;
        }
        else if ((((i + 1) < nl_list_text_len(tokens)) && ((nl_streq(tok_raw, "minus") || nl_streq(tok_raw, "subtraher")) || nl_streq(tok_raw, "subtraherer"))) && nl_streq(n1, "med")) {
            tok = "-";
            tok_step = 2;
        }
