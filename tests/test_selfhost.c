...
char * selfhost__compiler__uttrykk_til_ops_og_verdier_med_miljo(nl_list_text* tokens, nl_list_text* navn, nl_list_int* miljo_verdier, nl_list_text* ops, nl_list_int* verdier) {
    ...
    while (i < nl_list_text_len(tokens)) {
        ...
        char * tok = tok_raw;
        int tok_step = 1;
        if ((((((i + 3) < nl_list_text_len(tokens)) && nl_streq(tok_raw, "mindre")) && nl_streq(tokens->data[(i + 1)], "enn")) && nl_streq(tokens->data[(i + 2)], "eller")) && nl_streq(tokens->data[(i + 3)], "lik")) {
        ...
        else if ((((i + 1) < nl_list_text_len(tokens)) && nl_streq(tok_raw, "mindre")) && nl_streq(tokens->data[(i + 1)], "enn")) {
            tok = "mindre_enn";
            tok_step = 2;
        }
        ...
        else if (((((i + 2) < nl_list_text_len(tokens)) && nl_streq(tok_raw, "er")) && nl_streq(tokens->data[(i + 1)], "mindre")) && nl_streq(tokens->data[(i + 2)], "enn")) {
            tok = "mindre_enn";
            tok_step = 3;
        }
        else if (((((i + 2) < nl_list_text_len(tokens)) && nl_streq(tok_raw, "er")) && nl_streq(tokens->data[(i + 1)], "storre")) && nl_streq(tokens->data[(i + 2)], "enn")) {
            tok = "storre_enn";
            tok_step = 3;
        }
