...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        static nl_map_text *nl_web_dispatch_params(nl_map_text *routes, const char *method, const char *path) {
            ...
            char * std__env__hent(char * nokkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.env.hent";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_env_get(nokkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__env__finnes(char * nokkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.env.finnes";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_env_exists(nokkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__env__sett(char * nokkel, char * verdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.env.sett";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_env_set(nokkel, verdi);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__fil__les(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.fil.les";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_file_read_text(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__fil__skriv_fil(char * sti, char * innhold) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.fil.skriv_fil";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_file_write_text(sti, innhold, "w");
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__fil__append(char * sti, char * innhold) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.fil.append";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_file_write_text(sti, innhold, "a");
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__fil__finnes(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.fil.finnes";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_file_exists(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__lagring__finnes(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.finnes";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_file_exists(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            ...
            nl_map_text* std__lagring__last(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.last";
                nl_try_frame __nl_try_1;
                nl_push_try_frame(&__nl_try_1);
                if (setjmp(__nl_try_1.jump_point) == 0) {
                    if (!(nl_file_exists(sti))) {
                        nl_call_stack_len = nl_call_stack_mark;
                        return nl_map_text_new();
                    }
                    char * innhold = nl_file_read_text(sti);
                    if (nl_streq(nl_text_trim(innhold), "")) {
                        nl_call_stack_len = nl_call_stack_mark;
                        return nl_map_text_new();
                    }
                    nl_call_stack_len = nl_call_stack_mark;
                    return json_parse(innhold);
                    nl_pop_try_frame();
                } else {
                    nl_pop_try_frame();
                    char *feiltekst = nl_strdup(__nl_try_1.error_message ? __nl_try_1.error_message : "");
                    nl_call_stack_len = __nl_try_1.call_depth;
                    nl_throw(nl_concat(nl_concat(nl_concat("VerdiFeil: lagring.last feilet for ", sti), ": "), feiltekst));
                }
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            int std__lagring__lagre(char * sti, nl_map_text* data) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.lagre";
                nl_try_frame __nl_try_2;
                nl_push_try_frame(&__nl_try_2);
                if (setjmp(__nl_try_2.jump_point) == 0) {
                    nl_file_write_text(sti, json_stringify(data), "w");
                    nl_call_stack_len = nl_call_stack_mark;
                    return nl_map_text_len(data);
                    nl_pop_try_frame();
                } else {
                    nl_pop_try_frame();
                    char *feiltekst = nl_strdup(__nl_try_2.error_message ? __nl_try_2.error_message : "");
                    nl_call_stack_len = __nl_try_2.call_depth;
                    nl_throw(nl_concat(nl_concat(nl_concat("IOFeil: lagring.lagre feilet for ", sti), ": "), feiltekst));
                }
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__lagring__hent_tekst(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.hent_tekst";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_get(data, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__lagring__hent_tall(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.hent_tall";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_text_to_int(nl_map_text_get(data, nøkkel));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__lagring__hent_bool(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.hent_bool";
                nl_call_stack_len = nl_call_stack_mark;
                return (nl_streq(nl_map_text_get(data, nøkkel), "true") || nl_streq(nl_map_text_get(data, nøkkel), "sann"));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__lagring__sett_tekst(nl_map_text* data, char * nøkkel, char * verdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.sett_tekst";
                nl_map_text_set(data, nøkkel, verdi);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_len(data);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            ...
            int std__lagring__sett_tall(nl_map_text* data, char * nøkkel, int verdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.sett_tall";
                nl_map_text_set(data, nøkkel, nl_int_to_text(verdi));
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_len(data);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            ...
            int std__lagring__sett_bool(nl_map_text* data, char * nøkkel, int verdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.sett_bool";
                if (verdi) {
                    nl_map_text_set(data, nøkkel, "true");
                }
                else {
                    nl_map_text_set(data, nøkkel, "false");
                }
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_len(data);
                nl_call_stack_len = nl_call_stack_mark;
            ...
            int std__lagring__fjern(nl_map_text* data, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.lagring.fjern";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_remove(data, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__path__join(char * først, char * andre) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.path.join";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_path_join(først, andre);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__path__basename(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.path.basename";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_path_basename(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__path__dirname(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.path.dirname";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_path_dirname(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__path__exists(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.path.exists";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_path_exists(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__path__stem(char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.path.stem";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_path_stem(sti);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            ...
            int start() {
                ...
                char * hjem = std__env__hent("HOME");
                char * sti = std__path__join("/private/tmp", "norscode-cli-demo.json");
                nl_map_text* data = nl_map_text_new();
                std__lagring__sett_tekst(data, "navn", "Norscode");
                std__lagring__sett_tall(data, "kjoringer", 1);
                std__lagring__sett_bool(data, "aktiv", 1);
                std__lagring__lagre(sti, data);
                nl_map_text* lest = std__lagring__last(sti);
                nl_print_text("CLI-eksempel");
                nl_print_text(nl_concat("Hjem: ", hjem));
                nl_print_text(nl_concat("Katalog: ", std__path__dirname(sti)));
                nl_print_text(nl_concat("Filnavn: ", std__path__basename(sti)));
                nl_print_text(nl_concat("Eksisterer: ", nl_bool_to_text(std__fil__finnes(sti))));
                nl_print_text(nl_concat("Navn: ", std__lagring__hent_tekst(lest, "navn")));
                nl_print_text(nl_concat("Kjoringer: ", nl_int_to_text(std__lagring__hent_tall(lest, "kjoringer"))));
                nl_print_text(nl_concat("Aktiv: ", nl_bool_to_text(std__lagring__hent_bool(lest, "aktiv"))));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
