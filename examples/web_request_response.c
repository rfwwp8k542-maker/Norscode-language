    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        static nl_map_text *nl_web_dispatch_params(nl_map_text *routes, const char *method, const char *path) {
            ...
            int start() {
                ...
                nl_map_text_set(__nl_map_1, "side", "1");
                nl_map_text* __nl_map_2 = nl_map_text_new();
                nl_map_text_set(__nl_map_2, "accept", "application/json");
                nl_map_text* __nl_map_3 = nl_map_text_new();
                nl_map_text_set(__nl_map_3, "side", "1");
                nl_map_text* __nl_map_4 = nl_map_text_new();
                nl_map_text_set(__nl_map_4, "accept", "application/json");
                nl_map_text* ctx = nl_web_request_context("post", "/brukere", __nl_map_3, __nl_map_4, "{\"navn\":\"Ada\"}");
                nl_print_text(nl_web_request_method(ctx));
                nl_print_text(nl_web_request_query_param(ctx, "side"));
                nl_print_text(nl_web_request_header(ctx, "accept"));
                nl_map_text* __nl_map_5 = nl_map_text_new();
                nl_map_text_set(__nl_map_5, "content-type", "application/json");
                nl_map_text* __nl_map_6 = nl_map_text_new();
                nl_map_text_set(__nl_map_6, "content-type", "application/json");
                nl_map_text* respons = nl_web_response_builder(200, __nl_map_6, "{\"ok\":true}");
                printf("%d\n", nl_web_response_status(respons));
                nl_print_text(nl_web_response_header(respons, "content-type"));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
