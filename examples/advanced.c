...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        int std__math__pluss(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.pluss";
        ...
        int std__math__minus(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.minus";
            nl_call_stack_len = nl_call_stack_mark;
            return (a - b);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        ...
        int std__math__trekk(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.trekk";
            nl_call_stack_len = nl_call_stack_mark;
            return std__math__minus(a, b);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        }
        
        int std__math__gange(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.gange";
            nl_call_stack_len = nl_call_stack_mark;
            return (a * b);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        ...
        int std__math__del(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.del";
            if (b == 0) {
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
        ...
        int std__math__div(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.div";
            nl_call_stack_len = nl_call_stack_mark;
            return std__math__del(a, b);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        }
        
        int std__math__maks(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.maks";
            if (a > b) {
                nl_call_stack_len = nl_call_stack_mark;
                return a;
            }
        ...
        int std__math__min(int a, int b) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.min";
            if (a < b) {
                nl_call_stack_len = nl_call_stack_mark;
                return a;
            }
        ...
        int std__math__absolutt(int x) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.math.absolutt";
            if (x < 0) {
                nl_call_stack_len = nl_call_stack_mark;
                return (-(x));
            }
        ...
        int std__liste__legg_til_tall(nl_list_int* l, int verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.legg_til_tall";
        ...
        int std__liste__legg_til_tekst(nl_list_text* l, char * verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.legg_til_tekst";
        ...
        int std__liste__siste_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.siste_tall";
            nl_call_stack_len = nl_call_stack_mark;
        ...
        char * std__liste__siste_tekst(nl_list_text* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.siste_tekst";
            nl_call_stack_len = nl_call_stack_mark;
        ...
        int std__liste__første_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.første_tall";
        ...
        char * std__liste__første_tekst(nl_list_text* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.første_tekst";
            if (nl_list_text_len(l) == 0) {
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            nl_call_stack_len = nl_call_stack_mark;
        ...
        int std__liste__inneholder_tall(nl_list_int* l, int verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.inneholder_tall";
            int i = 0;
        ...
        int std__liste__inneholder_tekst(nl_list_text* l, char * verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.inneholder_tekst";
            int i = 0;
        ...
        int std__liste__antall_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.antall_tall";
            nl_call_stack_len = nl_call_stack_mark;
            return nl_list_int_len(l);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        ...
        int std__liste__antall_tekst(nl_list_text* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.antall_tekst";
            nl_call_stack_len = nl_call_stack_mark;
            return nl_list_text_len(l);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        ...
        int std__liste__fjern_tall(nl_list_int* l, int indeks) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.fjern_tall";
        ...
        int std__liste__fjern_tekst(nl_list_text* l, int indeks) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.fjern_tekst";
        ...
        int std__liste__sett_inn_tall(nl_list_int* l, int indeks, int verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.sett_inn_tall";
        ...
        int std__liste__sett_inn_tekst(nl_list_text* l, int indeks, char * verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.sett_inn_tekst";
        ...
        int std__liste__sorter_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.sorter_tall";
            int n = nl_list_int_len(l);
            int i = 0;
            while (i < n) {
                int j = 0;
                while ((j + 1) < (n - i)) {
        ...
        int std__liste__sorter_tekst(nl_list_text* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.sorter_tekst";
            int n = nl_list_text_len(l);
            int i = 0;
            while (i < n) {
                int j = 0;
                while ((j + 1) < (n - i)) {
                    if (strcmp(l->data[j] ? l->data[j] : "", l->data[(j + 1)] ? l->data[(j + 1)] : "") > 0) {
                        char * tmp = l->data[j];
                        l->data[j] = l->data[(j + 1)];
                        l->data[(j + 1)] = tmp;
                    }
        ...
        int std__liste__summer_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.summer_tall";
            int sum = 0;
            int i = 0;
            while (i < nl_list_int_len(l)) {
                sum = (sum + l->data[i]);
        ...
        int std__liste__maks_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.maks_tall";
            if (nl_list_int_len(l) == 0) {
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
        ...
        int std__liste__min_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.min_tall";
            if (nl_list_int_len(l) == 0) {
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
        ...
        int std__liste__omvendt_tall(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.omvendt_tall";
            int venstre = 0;
            int høyre = (nl_list_int_len(l) - 1);
            while (venstre < høyre) {
                int tmp = l->data[venstre];
                l->data[venstre] = l->data[høyre];
                l->data[høyre] = tmp;
                venstre = (venstre + 1);
                høyre = (høyre - 1);
            }
        ...
        int std__liste__finn_indeks_tall(nl_list_int* l, int verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.finn_indeks_tall";
            int i = 0;
            while (i < nl_list_int_len(l)) {
                if (l->data[i] == verdi) {
                    nl_call_stack_len = nl_call_stack_mark;
        ...
        int std__liste__finn_indeks_tekst(nl_list_text* l, char * verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.finn_indeks_tekst";
            int i = 0;
            while (i < nl_list_text_len(l)) {
                if (nl_streq(l->data[i], verdi)) {
                    nl_call_stack_len = nl_call_stack_mark;
        ...
        int std__liste__fjern_alle_tall(nl_list_int* l, int verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.fjern_alle_tall";
            int i = 0;
            while (i < nl_list_int_len(l)) {
                if (l->data[i] == verdi) {
        ...
        int std__liste__fjern_alle_tekst(nl_list_text* l, char * verdi) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "std.liste.fjern_alle_tekst";
            int i = 0;
            while (i < nl_list_text_len(l)) {
                if (nl_streq(l->data[i], verdi)) {
        ...
        int summer_liste(nl_list_int* l) {
            const int nl_call_stack_mark = nl_call_stack_len;
            nl_call_stack[nl_call_stack_len++] = "summer_liste";
            int sum = 0;
            for (int __nl_i_1 = 0; __nl_i_1 < nl_list_int_len(l); __nl_i_1++) {
                int x = l->data[__nl_i_1];
                sum = (sum + x);
            }
            nl_call_stack_len = nl_call_stack_mark;
            return sum;
        ...
        int start() {
            ...
            nl_list_int_push(tall, 1);
            nl_list_int_push(tall, 2);
            nl_list_int_push(tall, 3);
            nl_list_int_push(tall, 4);
            nl_list_int_push(tall, 5);
            char * s = "norscode";
            int total = summer_liste(tall);
            char * midten = nl_text_slice(s, 2, 1, 6, 1);
            nl_list_text* ord = nl_list_text_new();
            nl_list_text_push(ord, "zeta");
            nl_list_text_push(ord, "alpha");
            nl_list_text_push(ord, "gamma");
            std__liste__sorter_tekst(ord);
            nl_print_text("Sum av liste:");
            nl_print_text(nl_int_to_text(total));
            nl_print_text(midten);
            nl_print_text(ord->data[0]);
            nl_assert_eq_int(total, 15);
            nl_assert_ne_int(total, 10);
            nl_assert_eq_text(midten, "rsco");
            nl_assert_eq_text(ord->data[0], "alpha");
            char * melding = std__tekst__hilsen("Jan");
            nl_print_text(melding);
            int i = 0;
            while (i < 3) {
                nl_print_text(nl_concat("Loop: ", nl_int_to_text(i)));
                i = (i + 1);
            }
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
