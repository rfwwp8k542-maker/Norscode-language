...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        static nl_map_text *nl_web_dispatch_params(nl_map_text *routes, const char *method, const char *path) {
            ...
            int std__web__path_match(char * mønster, char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.path_match";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_path_match(mønster, sti);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            nl_map_text* std__web__path_params(char * mønster, char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.path_params";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_path_params(mønster, sti);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__path_param(nl_map_text* params, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.path_param";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_get(params, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__web__path_param_or(nl_map_text* params, char * nøkkel, char * fallback) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.path_param_or";
                if (nl_map_text_find(params, nøkkel) >= 0) {
                    nl_call_stack_len = nl_call_stack_mark;
                    return nl_map_text_get(params, nøkkel);
                }
                nl_call_stack_len = nl_call_stack_mark;
            ...
            int std__web__route_match(char * spec, char * metode, char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.route_match";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_route_match(spec, metode, sti);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__web__dispatch(nl_map_text* routes, char * metode, char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.dispatch";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_dispatch(routes, metode, sti);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__dispatch_params(nl_map_text* routes, char * metode, char * sti) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.dispatch_params";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_dispatch_params(routes, metode, sti);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__route(char * spec) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.route";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_route(spec);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__request_context(char * metode, char * sti, nl_map_text* query, nl_map_text* headers, char * body) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_context";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_context(metode, sti, query, headers, body);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__request_method(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_method";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_method(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__web__request_path(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_path";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_path(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__request_query(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_query";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_query(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            nl_map_text* std__web__request_headers(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_headers";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_headers(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__request_body(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_body";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_body(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__request_params(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_params";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_params(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__request_param(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_param";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_param(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__web__request_param_int(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_param_int";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_param_int(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__web__request_query_param(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_query_param";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_query_param(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__web__request_query_required(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_query_required";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_query_required(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__web__request_query_int(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_query_int";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_query_int(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__web__request_header(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_header";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_header(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__request_json(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_json";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_json(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__request_json_field(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_json_field";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_json_field(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            char * std__web__request_json_field_or(nl_map_text* ctx, char * nøkkel, char * fallback) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_json_field_or";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_json_field_or(ctx, nøkkel, fallback);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            int std__web__request_json_field_int(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_json_field_int";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_json_field_int(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__web__request_json_field_bool(nl_map_text* ctx, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.request_json_field_bool";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_request_json_field_bool(ctx, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            nl_map_text* std__web__response_builder(int status, nl_map_text* headers, char * body) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_builder";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_builder(status, headers, body);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            int std__web__response_status(nl_map_text* response) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_status";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_status(response);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            nl_map_text* std__web__response_headers(nl_map_text* response) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_headers";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_headers(response);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__response_body(nl_map_text* response) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_body";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_body(response);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            ...
            char * std__web__response_text(nl_map_text* response) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_text";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_text(response);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__response_json(nl_map_text* response) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_json";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_json(response);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            char * std__web__response_header(nl_map_text* response, char * nøkkel) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_header";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_header(response, nøkkel);
                nl_call_stack_len = nl_call_stack_mark;
                return "";
            }
            
            nl_map_text* std__web__response_error(int status, char * melding) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_error";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_error(status, melding);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            nl_map_text* std__web__response_file(char * sti, char * content_type) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.response_file";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_file(sti, content_type);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            
            nl_map_text* std__web__handle_request(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.web.handle_request";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_handle_request(ctx);
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            ...
            char * std__tekst__hilsen(char * navn) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.hilsen";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            char * std__tekst__rop(char * melding) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.rop";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            char * std__tekst__omgitt_av_klammer(char * tekstverdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.omgitt_av_klammer";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            char * std__tekst__ja_nei(int verdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.ja_nei";
                if (verdi) {
                    nl_call_stack_len = nl_call_stack_mark;
                    return "ja";
                }
            ...
            char * std__tekst__tall_til_tekst(int x) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.tall_til_tekst";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            char * std__tekst__bool_til_tekst(int x) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.bool_til_tekst";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            int std__tekst__starter_med(char * tekstverdi, char * prefiks) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.starter_med";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_text_starter_med(tekstverdi, prefiks);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__tekst__slutter_med(char * tekstverdi, char * suffiks) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.slutter_med";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_text_slutter_med(tekstverdi, suffiks);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            int std__tekst__inneholder(char * tekstverdi, char * deltekst) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.inneholder";
                nl_call_stack_len = nl_call_stack_mark;
                return nl_text_inneholder(tekstverdi, deltekst);
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            }
            
            char * std__tekst__trim(char * tekstverdi) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "std.tekst.trim";
                nl_call_stack_len = nl_call_stack_mark;
            ...
            nl_map_text* bruker(nl_map_text* ctx) {
                const int nl_call_stack_mark = nl_call_stack_len;
                nl_call_stack[nl_call_stack_len++] = "bruker";
                nl_web_route("GET /brukere/{id:int}");
                nl_map_text* __nl_map_1 = nl_map_text_new();
                nl_map_text_set(__nl_map_1, "content-type", "text/plain");
                nl_call_stack_len = nl_call_stack_mark;
                return nl_web_response_builder(200, __nl_map_1, nl_int_to_text(nl_web_request_param_int(ctx, "id")));
                nl_call_stack_len = nl_call_stack_mark;
                return nl_map_text_new();
            }
            ...
            int start() {
                ...
                nl_map_text* __nl_map_2 = nl_map_text_new();
                nl_map_text_set(__nl_map_2, "side", "2");
                nl_map_text* __nl_map_3 = nl_map_text_new();
                nl_map_text_set(__nl_map_3, "side", "2");
                nl_map_text* query_ctx = nl_web_request_context("get", "/sok", __nl_map_3, nl_map_text_new(), "");
                nl_print_text(nl_int_to_text(nl_web_request_query_int(query_ctx, "side")));
                nl_print_text(nl_web_request_json_field_or(nl_web_request_context("post", "/brukere", nl_map_text_new(), nl_map_text_new(), "{\"navn\":\"Ada\"}"), "navn", "ukjent"));
                nl_map_text* respons = nl_web_handle_request(nl_web_request_context("get", "/brukere/42", nl_map_text_new(), nl_map_text_new(), ""));
                nl_print_text(nl_web_response_body(respons));
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
                nl_call_stack_len = nl_call_stack_mark;
                return 0;
            ...
            static nl_map_text *nl_web_handle_request(nl_map_text *ctx) {
                ...
                { /* GET /brukere/{id:int} */
                    nl_map_text *params = nl_map_text_new();
                    if (nl_web_route_match_params("GET /brukere/{id:int}", method, path, params)) {
                        nl_map_text *route_ctx = nl_web_request_context(method, path, nl_web_request_query(ctx), nl_web_request_headers(ctx), nl_web_request_body(ctx));
                        nl_map_text_set(route_ctx, "params", json_stringify(params));
                        return bruker(route_ctx);
                    }
                    if (nl_web_route_path_match("GET /brukere/{id:int}", path)) { path_mismatch = 1; }
                }
                if (path_mismatch) {
