...
static int nl_json_skip_object_raw(const char *s, int *idx, int len) {
    ...
    static int nl_json_skip_array_raw(const char *s, int *idx, int len) {
        ...
        int std__lagring__hent_bool(nl_map_text* data, char * nøkkel) {
            ...
            nl_call_stack_len = nl_call_stack_mark;
            return nl_streq(nl_map_text_get(data, nøkkel), "true");
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        }
        ...
        int std__lagring__sett_bool(nl_map_text* data, char * nøkkel, int verdi) {
            ...
            nl_map_text_set(data, nøkkel, nl_bool_to_text(verdi));
            nl_call_stack_len = nl_call_stack_mark;
            return nl_map_text_len(data);
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
        ...
        int start() {
            ...
            nl_assert_eq_int(std__lagring__sett_tekst(data, "navn", "Ada"), 1);
            nl_assert_eq_int(std__lagring__sett_tall(data, "antall", 3), 2);
            nl_assert_eq_int(std__lagring__sett_bool(data, "klar", 1), 3);
            nl_assert_eq_int(nl_map_text_len(data), 3);
            nl_print_text(nl_int_to_text(std__lagring__lagre("/private/tmp/norscode_lagring_test.json", data)));
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
            nl_call_stack_len = nl_call_stack_mark;
            return 0;
