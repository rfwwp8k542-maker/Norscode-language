...
class SemanticAnalyzer:
    def __init__(self, alias_map=None):
        ...
        self.functions = {
            ...
            "tekst_til_små": FunctionSymbol("tekst_til_små", [TYPE_TEXT], TYPE_TEXT, True),
            "tekst_til_store": FunctionSymbol("tekst_til_store", [TYPE_TEXT], TYPE_TEXT, True),
            "tekst_til_tittel": FunctionSymbol("tekst_til_tittel", [TYPE_TEXT], TYPE_TEXT, True),
            "tekst_omvendt": FunctionSymbol("tekst_omvendt", [TYPE_TEXT], TYPE_TEXT, True),
            "tekst_del_på": FunctionSymbol("tekst_del_på", [TYPE_TEXT, TYPE_TEXT], TYPE_LIST_TEXT, True),
            "del_på": FunctionSymbol("del_på", [TYPE_TEXT, TYPE_TEXT], TYPE_LIST_TEXT, True),
            ...
            "tekst_slice": FunctionSymbol("tekst_slice", [TYPE_TEXT, TYPE_INT, TYPE_INT], TYPE_TEXT, True),
            "tekst_lengde": FunctionSymbol("tekst_lengde", [TYPE_TEXT], TYPE_INT, True),
            ...
            "tekst_erstatt": FunctionSymbol("tekst_erstatt", [TYPE_TEXT, TYPE_TEXT, TYPE_TEXT], TYPE_TEXT, True),
            "sass_til_css": FunctionSymbol("sass_til_css", [TYPE_TEXT], TYPE_TEXT, True),
            "web_server_start": FunctionSymbol("web_server_start", [TYPE_LIST_TEXT, TYPE_TEXT, TYPE_INT], TYPE_INT, True),
            "del_linjer": FunctionSymbol("del_linjer", [TYPE_TEXT], TYPE_LIST_TEXT, True),
            "del_ord": FunctionSymbol("del_ord", [TYPE_TEXT], TYPE_LIST_TEXT, True),
            "tekst_er_ordtegn": FunctionSymbol("tekst_er_ordtegn", [TYPE_TEXT], TYPE_BOOL, True),
            ...
            "gui_vindu": FunctionSymbol("gui_vindu", [TYPE_TEXT], TYPE_INT, True),
            "gui_panel": FunctionSymbol("gui_panel", [TYPE_INT], TYPE_INT, True),
            "gui_rad": FunctionSymbol("gui_rad", [TYPE_INT], TYPE_INT, True),
            "gui_tekst": FunctionSymbol("gui_tekst", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_tekstboks": FunctionSymbol("gui_tekstboks", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_editor": FunctionSymbol("gui_editor", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_editor_hopp_til": FunctionSymbol("gui_editor_hopp_til", [TYPE_INT, TYPE_INT], TYPE_INT, True),
            "gui_editor_cursor": FunctionSymbol("gui_editor_cursor", [TYPE_INT], TYPE_LIST_TEXT, True),
            "gui_editor_erstatt_fra_til": FunctionSymbol("gui_editor_erstatt_fra_til", [TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_liste": FunctionSymbol("gui_liste", [TYPE_INT], TYPE_INT, True),
            "gui_liste_legg_til": FunctionSymbol("gui_liste_legg_til", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_liste_tom": FunctionSymbol("gui_liste_tom", [TYPE_INT], TYPE_INT, True),
            "gui_liste_antall": FunctionSymbol("gui_liste_antall", [TYPE_INT], TYPE_INT, True),
            "gui_liste_filer_tre": FunctionSymbol("gui_liste_filer_tre", [TYPE_TEXT], TYPE_LIST_TEXT, True),
            "gui_liste_hent": FunctionSymbol("gui_liste_hent", [TYPE_INT, TYPE_INT], TYPE_TEXT, True),
            "gui_liste_fjern": FunctionSymbol("gui_liste_fjern", [TYPE_INT, TYPE_INT], TYPE_INT, True),
            "gui_på_klikk": FunctionSymbol("gui_på_klikk", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_på_endring": FunctionSymbol("gui_på_endring", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_på_tast": FunctionSymbol("gui_på_tast", [TYPE_INT, TYPE_TEXT, TYPE_TEXT], TYPE_INT, True),
            "gui_trykk": FunctionSymbol("gui_trykk", [TYPE_INT], TYPE_INT, True),
            "gui_trykk_tast": FunctionSymbol("gui_trykk_tast", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_foresatt": FunctionSymbol("gui_foresatt", [TYPE_INT], TYPE_INT, True),
            "gui_barn": FunctionSymbol("gui_barn", [TYPE_INT, TYPE_INT], TYPE_INT, True),
            "gui_knapp": FunctionSymbol("gui_knapp", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_etikett": FunctionSymbol("gui_etikett", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_tekstfelt": FunctionSymbol("gui_tekstfelt", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_sett_tekst": FunctionSymbol("gui_sett_tekst", [TYPE_INT, TYPE_TEXT], TYPE_INT, True),
            "gui_hent_tekst": FunctionSymbol("gui_hent_tekst", [TYPE_INT], TYPE_TEXT, True),
            "gui_vis": FunctionSymbol("gui_vis", [TYPE_INT], TYPE_INT, True),
            "gui_lukk": FunctionSymbol("gui_lukk", [TYPE_INT], TYPE_INT, True),
            "les_fil": FunctionSymbol("les_fil", [TYPE_TEXT], TYPE_TEXT, True),
            "skriv_fil": FunctionSymbol("skriv_fil", [TYPE_TEXT, TYPE_TEXT], TYPE_INT, True),
            "fil_eksisterer": FunctionSymbol("fil_eksisterer", [TYPE_TEXT], TYPE_BOOL, True),
            "db_open": FunctionSymbol("db_open", [TYPE_TEXT], TYPE_TEXT, True),
            "db_close": FunctionSymbol("db_close", [TYPE_TEXT], TYPE_INT, True),
            "db_begin": FunctionSymbol("db_begin", [TYPE_TEXT], TYPE_TEXT, True),
            "db_commit": FunctionSymbol("db_commit", [TYPE_TEXT], TYPE_INT, True),
            "db_rollback": FunctionSymbol("db_rollback", [TYPE_TEXT], TYPE_INT, True),
            "db_exec": FunctionSymbol("db_exec", [TYPE_TEXT, TYPE_LIST_TEXT], TYPE_INT, True),
            "db_query": FunctionSymbol("db_query", [TYPE_TEXT, TYPE_LIST_TEXT], TYPE_LIST_TEXT, True),
            "les_miljo": FunctionSymbol("les_miljo", [TYPE_TEXT], TYPE_TEXT, True),
            "argv": FunctionSymbol("argv", [], TYPE_LIST_TEXT, True),
            "kjør_kommando": FunctionSymbol("kjør_kommando", [TYPE_LIST_TEXT], TYPE_INT, True),
            "liste_filer": FunctionSymbol("liste_filer", [TYPE_TEXT], TYPE_LIST_TEXT, True),
            "liste_filer_tre": FunctionSymbol("liste_filer_tre", [TYPE_TEXT], TYPE_LIST_TEXT, True),
            "gui_liste_valgt": FunctionSymbol("gui_liste_valgt", [TYPE_INT], TYPE_TEXT, True),
            "gui_liste_velg": FunctionSymbol("gui_liste_velg", [TYPE_INT, TYPE_INT], TYPE_INT, True),
            "kjor_kilde": FunctionSymbol("kjor_kilde", [TYPE_TEXT], TYPE_TEXT, True),
