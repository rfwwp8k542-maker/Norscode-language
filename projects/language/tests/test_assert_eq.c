...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    int std_math__pluss(int a, int b) {
        return (a + b);
        return 0;
    }
    
    int std_math__minus(int a, int b) {
        return (a - b);
        return 0;
    }
    
    int std_math__gange(int a, int b) {
        return (a * b);
        return 0;
    }
    
    int std_math__del(int a, int b) {
        if (b == 0) {
            return 0;
        }
        return (a / b);
    ...
    int std_math__maks(int a, int b) {
        if (a > b) {
            return a;
        }
        return b;
    ...
    int start() {
        nl_assert_eq_int((2 + 3), 5);
        int sum = std_math__pluss(10, 20);
        nl_assert_eq_int(sum, 30);
        char * h = std_tekst__hilsen("Jan");
        nl_assert_eq_text(h, "Hei Jan");
        nl_assert_eq_int(1, 1);
        nl_print_text("test_assert_eq OK");
        return 0;
        return 0;
    }
    ...
    static int nl_call_callback(const char *name, int widget_id) {
        ...
        if (nl_streq(name, "absolutt") || nl_streq(name, "std.math.absolutt")) {
            return std_math__absolutt(widget_id);
        }
        return widget_id;
    }
