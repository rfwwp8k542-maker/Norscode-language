...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    int start() {
        nl_assert_eq_int(std_math__pluss(10, 20), 30);
        nl_assert_eq_int(std_math__minus(50, 8), 42);
        nl_assert_eq_int(std_math__maks(3, 7), 7);
        nl_assert_eq_int(std_math__min(3, 7), 3);
        nl_assert_eq_int(std_math__absolutt((-(9))), 9);
        nl_assert_eq_int(std_math__del(8, 0), 0);
        nl_assert_eq_int(std_math__del(9, 3), 3);
        return 0;
        return 0;
    }
