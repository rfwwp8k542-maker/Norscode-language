...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    int start() {
        nl_assert_eq_text(std_tekst__hilsen("Nora"), "Hei Nora");
        nl_assert_eq_text(std_tekst__rop("hei"), "hei!");
        nl_assert_eq_text(std_tekst__omgitt_av_klammer("x"), "[x]");
        nl_assert_eq_text(std_tekst__ja_nei(1), "ja");
        nl_assert_eq_text(std_tekst__tall_til_tekst(42), "42");
        nl_assert_eq_text(std_tekst__bool_til_tekst(0), "usann");
        nl_assert_eq_text(std_tekst__slice("Hei verden", 4, 10), "verden");
        nl_assert_eq_int(std_tekst__lengde_tekst("hei"), 3);
        nl_assert(std_tekst__tekst_er_ordtegn("Å"));
