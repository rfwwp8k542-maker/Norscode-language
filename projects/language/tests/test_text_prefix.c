...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    char * std_tekst__hilsen(char * navn) {
        return nl_concat("Hei ", navn);
        return "";
    }
    
    char * std_tekst__rop(char * melding) {
        return nl_concat(melding, "!");
        return "";
    }
    
    char * std_tekst__omgitt_av_klammer(char * tekstverdi) {
        return nl_concat(nl_concat("[", tekstverdi), "]");
        return "";
    }
    
    char * std_tekst__ja_nei(int verdi) {
        if (verdi) {
            return "ja";
        }
        return "nei";
    ...
    char * std_tekst__tall_til_tekst(int x) {
        return nl_int_to_text(x);
        return "";
    }
    
    char * std_tekst__bool_til_tekst(int x) {
        return nl_bool_to_text(x);
        return "";
    }
    
    char * std_tekst__slice(char * tekstverdi, int start, int slutt) {
        return nl_text_slice(tekstverdi, start, slutt);
        return "";
    }
    
    int std_tekst__lengde_tekst(char * tekstverdi) {
        return nl_text_length(tekstverdi);
        return 0;
    }
    
    int std_tekst__tekst_er_ordtegn(char * tegn) {
        if (nl_streq(tegn, "")) {
            return 0;
        }
        if ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((nl_streq(tegn, "_") || nl_streq(tegn, "a")) || nl_streq(tegn, "b")) || nl_streq(tegn, "c")) || nl_streq(tegn, "d")) || nl_streq(tegn, "e")) || nl_streq(tegn, "f")) || nl_streq(tegn, "g")) || nl_streq(tegn, "h")) || nl_streq(tegn, "i")) || nl_streq(tegn, "j")) || nl_streq(tegn, "k")) || nl_streq(tegn, "l")) || nl_streq(tegn, "m")) || nl_streq(tegn, "n")) || nl_streq(tegn, "o")) || nl_streq(tegn, "p")) || nl_streq(tegn, "q")) || nl_streq(tegn, "r")) || nl_streq(tegn, "s")) || nl_streq(tegn, "t")) || nl_streq(tegn, "u")) || nl_streq(tegn, "v")) || nl_streq(tegn, "w")) || nl_streq(tegn, "x")) || nl_streq(tegn, "y")) || nl_streq(tegn, "z")) || nl_streq(tegn, "A")) || nl_streq(tegn, "B")) || nl_streq(tegn, "C")) || nl_streq(tegn, "D")) || nl_streq(tegn, "E")) || nl_streq(tegn, "F")) || nl_streq(tegn, "G")) || nl_streq(tegn, "H")) || nl_streq(tegn, "I")) || nl_streq(tegn, "J")) || nl_streq(tegn, "K")) || nl_streq(tegn, "L")) || nl_streq(tegn, "M")) || nl_streq(tegn, "N")) || nl_streq(tegn, "O")) || nl_streq(tegn, "P")) || nl_streq(tegn, "Q")) || nl_streq(tegn, "R")) || nl_streq(tegn, "S")) || nl_streq(tegn, "T")) || nl_streq(tegn, "U")) || nl_streq(tegn, "V")) || nl_streq(tegn, "W")) || nl_streq(tegn, "X")) || nl_streq(tegn, "Y")) || nl_streq(tegn, "Z")) || nl_streq(tegn, "0")) || nl_streq(tegn, "1")) || nl_streq(tegn, "2")) || nl_streq(tegn, "3")) || nl_streq(tegn, "4")) || nl_streq(tegn, "5")) || nl_streq(tegn, "6")) || nl_streq(tegn, "7")) || nl_streq(tegn, "8")) || nl_streq(tegn, "9")) || nl_streq(tegn, "æ")) || nl_streq(tegn, "ø")) || nl_streq(tegn, "å")) || nl_streq(tegn, "Æ")) || nl_streq(tegn, "Ø")) || nl_streq(tegn, "Å")) {
            return 1;
        }
        return 0;
        return 0;
    ...
    char * std_tekst__erstatt_ord_i_tekst(char * kilde, char * gammelt, char * nytt) {
        if (nl_streq(gammelt, "")) {
            return kilde;
        }
        char * resultat = "";
        int indeks = 0;
        int kilde_lengde = nl_text_length(kilde);
        int gammelt_lengde = nl_text_length(gammelt);
        while (indeks < kilde_lengde) {
            char * resten = nl_text_slice(kilde, indeks, kilde_lengde);
            if (nl_text_starter_med(resten, gammelt)) {
                char * forrige = "";
                char * neste = "";
                if (indeks > 0) {
                    forrige = nl_text_slice(kilde, (indeks - 1), indeks);
                }
                if ((indeks + gammelt_lengde) < kilde_lengde) {
                    neste = nl_text_slice(kilde, (indeks + gammelt_lengde), ((indeks + gammelt_lengde) + 1));
                }
                if ((indeks == 0) || (!(nl_text_er_ordtegn(forrige)))) {
                    if (((indeks + gammelt_lengde) == kilde_lengde) || (!(nl_text_er_ordtegn(neste)))) {
                        resultat = nl_concat(resultat, nytt);
                        indeks = (indeks + gammelt_lengde);
                    }
                    else {
                        resultat = nl_concat(resultat, nl_text_slice(kilde, indeks, (indeks + 1)));
                        indeks = (indeks + 1);
                    }
                }
                else {
    ...
    int start() {
        nl_assert(nl_text_starter_med("Feil: noe gikk galt", "Feil:"));
        nl_assert_ne_int(nl_text_starter_med("Hei verden", "Feil:"), 1);
        nl_assert(nl_text_inneholder("Hei verden", "ver"));
        nl_assert_ne_int(nl_text_inneholder("Hei verden", "zzz"), 1);
        nl_assert_eq_text(nl_text_erstatt("Hei verden", "verden", "Norscode"), "Hei Norscode");
        nl_assert_eq_text(nl_text_slice("Hei verden", 0, 3), "Hei");
        nl_assert_eq_text(nl_text_slice("Hei verden", 4, 10), "verden");
        nl_assert_eq_int(nl_text_length("Hei verden"), 10);
        nl_assert_eq_int(nl_list_text_len(nl_split_lines("linje 1\nlinje 2")), 2);
        nl_assert_eq_int(nl_list_text_len(nl_split_lines("")), 1);
        nl_assert_eq_text(std_tekst__erstatt_ord_i_tekst("start startx start", "start", "sett"), "sett startx sett");
        nl_assert(std_tekst__tekst_er_ordtegn("a"));
        nl_assert(std_tekst__tekst_er_ordtegn("_"));
        nl_assert_ne_int(std_tekst__tekst_er_ordtegn("-"), 1);
        nl_print_text("test_text_prefix OK");
        return 0;
        return 0;
    }
