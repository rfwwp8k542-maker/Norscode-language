...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    int butikk__moms(int pris) {
        return (pris + 25);
        return 0;
    }
    
    int butikk__rabatt(int pris, int avslag) {
        return (pris - avslag);
        return 0;
    }
    
    int butikk__total_med_moms_og_rabatt(int pris, int avslag) {
        int etter_rabatt = butikk__rabatt(pris, avslag);
        int total = butikk__moms(etter_rabatt);
        return total;
        return 0;
    }
    
    int start() {
        int pris = butikk__total_med_moms_og_rabatt(100, 20);
        nl_assert_eq_int(pris, 105);
        return 0;
        return 0;
    }
