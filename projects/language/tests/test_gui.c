...
static nl_list_text *nl_split_lines(const char *s) {
    ...
    int std_gui__rad(int foresatt) {
        return nl_gui_rad(foresatt);
        return 0;
    }
    ...
    int std_gui__editor(int foresatt, char * starttekst) {
        return nl_gui_editor(foresatt, starttekst);
        return 0;
    }
    
    int std_gui__editor_hopp_til(int editor_id, int linje) {
        return nl_gui_editor_hopp_til(editor_id, linje);
        return 0;
    }
    
    nl_list_text* std_gui__editor_cursor(int editor_id) {
        return nl_gui_editor_cursor(editor_id);
        return nl_list_text_new();
    }
    
    int std_gui__editor_erstatt_fra_til(int editor_id, int start_linje, int start_kol, int slutt_linje, int slutt_kol, char * tekstverdi) {
        return nl_gui_editor_replace_range(editor_id, start_linje, start_kol, slutt_linje, slutt_kol, tekstverdi);
        return 0;
    }
    ...
    int std_gui__liste_antall(int liste_id) {
        return nl_gui_liste_antall(liste_id);
        return 0;
    }
    
    nl_list_text* std_gui__liste_filer_tre(char * sti) {
        return nl_list_files_tree(sti);
        return nl_list_text_new();
    }
    
    char * std_gui__liste_hent(int liste_id, int indeks) {
        return nl_gui_liste_hent(liste_id, indeks);
        return "";
    }
    
    int std_gui__liste_fjern(int liste_id, int indeks) {
        return nl_gui_liste_fjern(liste_id, indeks);
        return 0;
    }
    
    char * std_gui__liste_valgt(int liste_id) {
        return nl_gui_liste_valgt(liste_id);
        return "";
    }
    
    int std_gui__liste_velg(int liste_id, int indeks) {
        return nl_gui_liste_velg(liste_id, indeks);
        return 0;
    }
    ...
    int std_gui__p__tast(int widget_id, char * tast, char * funksjonsnavn) {
        return nl_gui_pa_tast(widget_id, tast, funksjonsnavn);
        return 0;
    }
    ...
    int std_gui__trykk_tast(int widget_id, char * tast) {
        return nl_gui_trykk_tast(widget_id, tast);
        return 0;
    }
    ...
    int knapp_trykket(int widget_id) {
        std_gui__sett_tekst(widget_id, "Trykket");
        return widget_id;
        return 0;
    }
    
    int tekst_endret(int widget_id) {
        nl_print_text(std_gui__hent_tekst(widget_id));
        return widget_id;
        return 0;
    }
    ...
    static int nl_call_callback(const char *name, int widget_id) {
        ...
        if (nl_streq(name, "rad") || nl_streq(name, "std.gui.rad")) {
            return std_gui__rad(widget_id);
        }
        ...
        if (nl_streq(name, "liste_antall") || nl_streq(name, "std.gui.liste_antall")) {
            return std_gui__liste_antall(widget_id);
        }
        ...
        if (nl_streq(name, "knapp_trykket") || nl_streq(name, "knapp_trykket")) {
            return knapp_trykket(widget_id);
        }
        if (nl_streq(name, "tekst_endret") || nl_streq(name, "tekst_endret")) {
            return tekst_endret(widget_id);
        }
        return widget_id;
    }
